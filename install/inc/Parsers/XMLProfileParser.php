...
class XMLProfileParser extends BaseProfileParser
{
    ...
    {
        $locale_list = [];
        if ($this->base && $this->base->locales) {
            $locale_list[] = $this->base->locales->children();
        }
        if ($this->xml->locales) {
    ...
    {
        $lists_list = [];
        if ($this->base && $this->base->lists) {
            $lists_list[] = $this->base->lists->children();
        }
        if ($this->xml->lists) {
    ...
    {
        $elements_list = [];
        if ($this->base && $this->base->elementSets) {
            $elements_list[] = $this->base->elementSets->children();
        }
        if ($this->xml->elementSets) {
    ...
    public function processRelationshipTypes()
    {
        ...
        if ($this->base && $this->base->relationshipTypes) {
            $relationship_types_list[] = $this->base->relationshipTypes->children();
        }
        if ($this->xml->relationshipTypes) {
    ...
    {
        $ui_list = [];
        if ($this->base && $this->base->userInterfaces) {
            $ui_list[] = $this->base->userInterfaces->children();
        }
        if ($this->xml->userInterfaces) {
    ...
    {
        $login_list = [];
        if ($this->base && $this->base->logins) {
            $login_list[] = $this->base->logins->children();
        }
        if ($this->xml->logins) {
    ...
    {
        $display_list = [];
        if ($this->base && $this->base->displays) {
            $display_list[] = $this->base->displays->children();
        }
        if ($this->xml->displays) {
    ...
    {
        $dict_list = [];
        if ($this->base && $this->base->metadataDictionary) {
            $dict_list[] = $this->base->metadataDictionary->children();
        }
        if ($this->xml->metadataDictionary) {
    ...
    {
        $role_list = [];
        if ($this->base && $this->base->roles) {
            $role_list[] = $this->base->roles->children();
        }
        if ($this->xml->roles) {
    ...
    {
        $group_list = [];
        if ($this->base && $this->base->groups) {
            $group_list[] = $this->base->groups->children();
        }
        if ($this->xml->groups) {
    ...
    {
        $form_list = [];
        if ($this->base && $this->base->searchForms) {
            $form_list[] = $this->base->searchForms->children();
        }
        if ($this->xml->searchForms) {
    ...
    {
        $alert_list = [];
        if ($this->base && $this->base->metadataAlerts) {
            $alert_list[] = $this->base->metadataAlerts->children();
        }
        if ($this->xml->metadataAlerts) {
            $alert_list[] = $this->xml->metadataAlerts->children();
        }
