...
class listItemSplitterRefinery extends BaseRefinery
{
    ...
    public function refine(&$pa_destination_data, $pa_group, $pa_item, $pa_source_data, $pa_options=null)
    {
        ...
        if (!$vn_list_id) {
            // No list = bail!
            if ($o_log) {
                $o_log->logError(_t('[listItemSplitterRefinery] Could not find list %1; item was skipped', $vs_list));
            }
            return array();
        }
...
BaseRefinery::$s_refinery_settings['listItemSplitter'] = array(
    ...
    'listItemSplitter_relationshipTypeDelimiter' => array(
        'formatType' => FT_TEXT,
        'displayType' => DT_FIELD,
        'width' => 10, 'height' => 1,
        'takesLocale' => false,
    ...
    'listItemSplitter_textTransform' => array(
        'formatType' => FT_TEXT,
        'displayType' => DT_SELECT,
        'width' => 10, 'height' => 1,
        'takesLocale' => false,
    ...
    'listItemSplitter_useRawValues' => array(
        'formatType' => FT_TEXT,
        'displayType' => DT_SELECT,
        'width' => 10, 'height' => 1,
        'takesLocale' => false,
