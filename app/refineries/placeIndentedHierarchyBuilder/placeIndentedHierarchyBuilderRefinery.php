...
{
    # -------------------------------------------------------
    public static $level_values = null;
    public static $level_value_ids = null;
    public static $level_parent_ids = null;
        ...
        foreach ($levels as $i => $level_placeholder) {
            ...
            if (strlen($level_placeholder)) {
                if ($level_value = BaseRefinery::parsePlaceholder($level_placeholder, $source_data, $item, 0, array('reader' => caGetOption('reader', $options, null), 'returnAsString' => true))) {
                    ...
                    if ($place_id = DataMigrationUtils::getPlaceID(
                        $level_value,
                        $parent_id,
                        $type,
                        $locale_id,
                        $hier_id,
                        ['idno' => preg_replace("![^A-Za-z0-9_]+!", "_", $level_value)],
                        [
