...
class collectionIndentedHierarchyBuilderRefinery extends BaseRefinery
{
    ...
    public static $opa_level_values = null;
    public static $opa_level_value_ids = null;
    ...
    public function refine(&$pa_destination_data, $pa_group, $pa_item, $pa_source_data, $pa_options=null)
    {
        ...
        if (!is_array($va_attributes = $pa_item['settings']['collectionIndentedHierarchyBuilder_attributes'])) {
            $va_attributes = null;
        }
        if (!is_array($va_relationships = $pa_item['settings']['collectionIndentedHierarchyBuilder_relationships'])) {
            $va_relationships = null;
        }
        ...
        if (!is_array($va_level_value_ids)) {
            $va_level_value_ids = [];
        }
