...
class storageLocationSplitterRefinery extends BaseRefinery
{
    ...
    public function refine(&$pa_destination_data, $pa_group, $pa_item, $pa_source_data, $pa_options=null)
    {
        ...
        $pa_options['defaultParentID'] = $t_loc->getHierarchyRootID();
...
BaseRefinery::$s_refinery_settings['storageLocationSplitter'] = array(
    ...
    'storageLocationSplitter_matchOn' => array(
        'formatType' => FT_TEXT,
        'displayType' => DT_SELECT,
        'width' => 10, 'height' => 1,
        'takesLocale' => false,
    ...
    'storageLocationSplitter_ignoreType' => array(
        'formatType' => FT_TEXT,
    ...
    'storageLocationSplitter_ignoreParent' => array(
        'formatType' => FT_TEXT,
        'displayType' => DT_FIELD,
        'width' => 10, 'height' => 1,
        'takesLocale' => false,
    ...
    'storageLocationSplitter_dontCreate' => array(
        'formatType' => FT_TEXT,
        'displayType' => DT_SELECT,
        'width' => 10, 'height' => 1,
        'takesLocale' => false,
    ...
    'storageLocationSplitter_extractRelationshipType' => array(
        'formatType' => FT_TEXT,
        'displayType' => DT_SELECT,
        'width' => 10, 'height' => 1,
        'takesLocale' => false,
    ...
    'storageLocationSplitter_interstitial' => array(
        'formatType' => FT_TEXT,
        'displayType' => DT_SELECT,
        'width' => 10, 'height' => 1,
        'takesLocale' => false,
        ...
        'description' => _t('Sets or maps metadata for the interstitial storage location <em>relationship</em> record by referencing the metadataElement code and the location in the data source where the data values can be found.')
    ),
    'storageLocationSplitter_nonPreferredLabels' => array(
        'formatType' => FT_TEXT,
        'displayType' => DT_SELECT,
        'width' => 10, 'height' => 1,
        'takesLocale' => false,
        ...
        'description' => _t('List of non-preferred labels to apply to storage locations.')
    ),
    'storageLocationSplitter_relationships' => array(
        'formatType' => FT_TEXT,
        'displayType' => DT_SELECT,
        'width' => 10, 'height' => 1,
        'takesLocale' => false,
    ...
    'storageLocationSplitter_textTransform' => array(
        'formatType' => FT_TEXT,
        'displayType' => DT_SELECT,
        'width' => 10, 'height' => 1,
        'takesLocale' => false,
    ...
    'storageLocationSplitter_useRawValues' => array(
        'formatType' => FT_TEXT,
        'displayType' => DT_SELECT,
        'width' => 10, 'height' => 1,
        'takesLocale' => false,
