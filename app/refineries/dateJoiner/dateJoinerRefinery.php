    ...
    public function refine(&$pa_destination_data, $pa_group, $pa_item, $pa_source_data, $pa_options=null)
    {
        ...
        switch($vs_mode = $pa_item['settings']['dateJoiner_mode']) {
            ...
            case 'multiColumnDate':
                ...
                if ($vs_date_day = trim(BaseRefinery::parsePlaceholder($pa_item['settings']['dateJoiner_day'], $pa_source_data, $pa_item, $vn_c, array('reader' => caGetOption('reader', $pa_options, null), 'returnAsString' => true)))) {
                    $va_date[] = $vs_date_day;
                }
                if ($vs_date_year = trim(BaseRefinery::parsePlaceholder($pa_item['settings']['dateJoiner_year'], $pa_source_data, $pa_item, $vn_c, array('reader' => caGetOption('reader', $pa_options, null), 'returnAsString' => true)))) {
                ...
                if (sizeof($va_date)) {							// TODO: this is assuming US-style dates for now
                    ...
                    if ($o_log) {
                        $o_log->logWarn(_t('[dateJoinerRefinery] Could not find multiColumnDate values. Is your configuration correct?'));
                    }
                }
                break;
            case 'multiColumnRange':
                ...
                if ($vs_date_day = trim(BaseRefinery::parsePlaceholder($pa_item['settings']['dateJoiner_startDay'], $pa_source_data, $pa_item, $vn_c, array('reader' => caGetOption('reader', $pa_options, null), 'returnAsString' => true)))) {
                    $va_date[] = $vs_date_day;
                }
                if ($vs_date_year = trim(BaseRefinery::parsePlaceholder($pa_item['settings']['dateJoiner_startYear'], $pa_source_data, $pa_item, $vn_c, array('reader' => caGetOption('reader', $pa_options, null), 'returnAsString' => true)))) {
                    $va_date[] = $vs_date_year;
                }
                ...
                if (sizeof($va_date)) {
                    ...
                    if ($o_log) {
                        $o_log->logWarn(_t('[dateJoinerRefinery] Could not find multiColumnRange value for start date. Is your configuration correct?'));
                    }
                }
                ...
                if ($vs_date_day = trim(BaseRefinery::parsePlaceholder($pa_item['settings']['dateJoiner_endDay'], $pa_source_data, $pa_item, $vn_c, array('reader' => caGetOption('reader', $pa_options, null), 'returnAsString' => true)))) {
                    $va_date[] = $vs_date_day;
                }
                if ($vs_date_year = trim(BaseRefinery::parsePlaceholder($pa_item['settings']['dateJoiner_endYear'], $pa_source_data, $pa_item, $vn_c, array('reader' => caGetOption('reader', $pa_options, null), 'returnAsString' => true)))) {
                    $va_date[] = $vs_date_year;
                }
                ...
                if (sizeof($va_date)) {
                    ...
                    if ($o_log) {
                        $o_log->logWarn(_t('[dateJoinerRefinery] Could not find multiColumnRange value for end date. Is your configuration correct?'));
                    }
                }
                ...
                if (sizeof($va_dates) > 0) {
                    ...
                    if ($o_log) {
                        $o_log->logWarn(_t('[dateJoinerRefinery] Could not find multiColumnRange values. Is your configuration correct?'));
                    }
                }
                break;
        }
