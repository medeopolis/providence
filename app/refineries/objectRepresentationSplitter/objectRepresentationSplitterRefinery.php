...
BaseRefinery::$s_refinery_settings['objectRepresentationSplitter'] = array(
    ...
    'objectRepresentationSplitter_extractRelationshipType' => array(
        'formatType' => FT_TEXT,
        'displayType' => DT_SELECT,
        'width' => 10, 'height' => 1,
        'takesLocale' => false,
    ...
    'objectRepresentationSplitter_isPrimary' => array(
        'formatType' => FT_TEXT,
        'displayType' => DT_SELECT,
        'width' => 10, 'height' => 1,
        'takesLocale' => false,
    ...
    'objectRepresentationSplitter_textTransform' => array(
        'formatType' => FT_TEXT,
        'displayType' => DT_SELECT,
        'width' => 10, 'height' => 1,
        'takesLocale' => false,
    ...
    'objectRepresentationSplitter_useRawValues' => array(
        'formatType' => FT_TEXT,
        'displayType' => DT_SELECT,
        'width' => 10, 'height' => 1,
        'takesLocale' => false,
