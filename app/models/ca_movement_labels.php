<?php
/** ---------------------------------------------------------------------
 * app/models/ca_movement_labels.php : table access class for table ca_movement_labels
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_movement_labels'] = array(
    'NAME_SINGULAR' 	=> _t('movement title'),
    'NAME_PLURAL' 		=> _t('movement titles'),
    'FIELDS' 			=> array(
        'label_id' => array(
        ...
        'type_id' => array(
                ...
                'LIST_CODE' => 'movement_label_types',
...
class ca_movement_labels extends BaseLabel
{
    ...
    protected $TABLE = 'ca_movement_labels';
    ...
    protected $LABEL_SUBJECT_TABLE = 'ca_movements';
