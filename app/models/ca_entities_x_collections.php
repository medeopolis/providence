<?php
/** ---------------------------------------------------------------------
 * app/models/ca_entities_x_collections.php : table access class for table ca_entities_x_collections
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_entities_x_collections'] = array(
    'NAME_SINGULAR' 	=> _t('entity ⇔ collection relationship'),
    'NAME_PLURAL' 		=> _t('entity ⇔ collection relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_entities_x_collections extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_entities_x_collections';
