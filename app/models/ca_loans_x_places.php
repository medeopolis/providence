<?php
/** ---------------------------------------------------------------------
 * app/models/ca_loans_x_places.php : table access class for table ca_loans_x_places
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_loans_x_places'] = array(
    'NAME_SINGULAR' 	=> _t('loans ⇔ places relationship'),
    'NAME_PLURAL' 		=> _t('loans ⇔ places relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_loans_x_places extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_loans_x_places';
