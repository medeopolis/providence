<?php
/** ---------------------------------------------------------------------
 * app/models/ca_entities_x_storage_locations.php : table access class for table ca_entities_x_storage_locations
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_entities_x_storage_locations'] = array(
    'NAME_SINGULAR' 	=> _t('entity ⇔ storage location relationship'),
    'NAME_PLURAL' 		=> _t('entity ⇔ storage location relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_entities_x_storage_locations extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_entities_x_storage_locations';
