<?php
/** ---------------------------------------------------------------------
 * app/models/ca_object_representations_x_occurrences.php : table access class for table ca_object_representations_x_occurrences
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_object_representations_x_occurrences'] = array(
    'NAME_SINGULAR' 	=> _t('object representation ⇔ occurrence relationship'),
    'NAME_PLURAL' 		=> _t('object representation ⇔ occurrence relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
        ...
        'occurrence_id' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Occurrence id', 'DESCRIPTION' => 'Identifier for Occurrence'
        ),
        'type_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
        ...
        'is_primary' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => _t('Is primary?'), 'DESCRIPTION' => _t('Indicates that the representation should be used to depict the occurrence is situations where only a single representation can be displayed (eg. search results).')
        ),
        'rank' => array(
...
class ca_object_representations_x_occurrences extends BaseRepresentationRelationship
{
    ...
    protected $TABLE = 'ca_object_representations_x_occurrences';
    ...
    protected $LOG_CHANGES_USING_AS_SUBJECT = array(
        "FOREIGN_KEYS" => array(
            'representation_id', 'occurrence_id'
        ),
    ...
    # --- Relationship info
    # ------------------------------------------------------
    protected $RELATIONSHIP_LEFT_TABLENAME = 'ca_object_representations';
    protected $RELATIONSHIP_RIGHT_TABLENAME = 'ca_occurrences';
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'representation_id';
    protected $RELATIONSHIP_RIGHT_FIELDNAME = 'occurrence_id';
