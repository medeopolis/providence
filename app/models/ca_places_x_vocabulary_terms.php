<?php
/** ---------------------------------------------------------------------
 * app/models/ca_places_x_vocabulary_terms.php : table access class for table ca_places_x_vocabulary_terms
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_places_x_vocabulary_terms'] = array(
    'NAME_SINGULAR' 	=> _t('place ⇔ vocabulary term relationship'),
    'NAME_PLURAL' 		=> _t('place ⇔ vocabulary term relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_places_x_vocabulary_terms extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_places_x_vocabulary_terms';
