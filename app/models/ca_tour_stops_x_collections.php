<?php
/** ---------------------------------------------------------------------
 * app/models/ca_tour_stops_x_collections.php : table access class for table ca_tour_stops_x_collections
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_tour_stops_x_collections'] = array(
    'NAME_SINGULAR' 	=> _t('tour stop ⇔ collection relationship'),
    'NAME_PLURAL' 		=> _t('tour stop ⇔ collection relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_tour_stops_x_collections extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_tour_stops_x_collections';
