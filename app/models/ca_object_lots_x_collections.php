...
BaseModel::$s_ca_models_definitions['ca_object_lots_x_collections'] = array(
    'NAME_SINGULAR' 	=> _t('object lot ⇔ collection relationship'),
    'NAME_PLURAL' 		=> _t('object lot ⇔ collection relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_object_lots_x_collections extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_object_lots_x_collections';
