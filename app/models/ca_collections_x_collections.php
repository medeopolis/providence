<?php
/** ---------------------------------------------------------------------
 * app/models/ca_collections_x_collections.php : table access class for table ca_collections_x_collections
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_collections_x_collections'] = array(
    'NAME_SINGULAR' 	=> _t('collection ⇔ collection relationship'),
    'NAME_PLURAL' 		=> _t('collection ⇔ collection relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
        ...
        'collection_left_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Collection left id', 'DESCRIPTION' => 'Collection left id'
        ),
        'collection_right_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Collection right id', 'DESCRIPTION' => 'Collection right id'
        ),
        'type_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
...
class ca_collections_x_collections extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_collections_x_collections';
    ...
    protected $LOG_CHANGES_USING_AS_SUBJECT = array(
        "FOREIGN_KEYS" => array(
            'collection_left_id', 'collection_right_id'
        ),
    ...
    # --- Relationship info
    # ------------------------------------------------------
    protected $RELATIONSHIP_LEFT_TABLENAME = 'ca_collections';
    protected $RELATIONSHIP_RIGHT_TABLENAME = 'ca_collections';
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'collection_left_id';
    protected $RELATIONSHIP_RIGHT_FIELDNAME = 'collection_right_id';
