<?php
/** ---------------------------------------------------------------------
 * app/models/ca_occurrences_x_storage_locations.php : table access class for table ca_occurrences_x_storage_locations
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_occurrences_x_storage_locations'] = array(
    ...
    'NAME_PLURAL' 		=> _t('occurrences ⇔ storage locations relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_occurrences_x_storage_locations extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_occurrences_x_storage_locations';
