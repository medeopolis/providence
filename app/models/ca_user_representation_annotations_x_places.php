<?php
/** ---------------------------------------------------------------------
 * app/models/ca_user_representation_annotations_x_places.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_user_representation_annotations_x_places'] = array(
    'NAME_SINGULAR' 	=> _t('user representation annotation ⇔ place relationship'),
    'NAME_PLURAL' 		=> _t('user representation annotation ⇔ place relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_user_representation_annotations_x_places extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_user_representation_annotations_x_places';
