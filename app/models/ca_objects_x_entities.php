<?php
/** ---------------------------------------------------------------------
 * app/models/ca_objects_x_entities.php : table access class for table ca_objects_x_entities
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_objects_x_entities'] = array(
    'NAME_SINGULAR' 	=> _t('object ⇔ entity relationship'),
    'NAME_PLURAL' 		=> _t('object ⇔ entity relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_objects_x_entities extends ObjectRelationshipBaseModel
{
    ...
    protected $TABLE = 'ca_objects_x_entities';
