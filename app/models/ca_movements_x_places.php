<?php
/** ---------------------------------------------------------------------
 * app/models/ca_movements_x_places.php : table access class for table ca_movements_x_places
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_movements_x_places'] = array(
    'NAME_SINGULAR' 	=> _t('movements ⇔ places relationship'),
    'NAME_PLURAL' 		=> _t('movements ⇔ places relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_movements_x_places extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_movements_x_places';
