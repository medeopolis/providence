...
class ca_object_representation_multifiles extends BaseModel
{
    ...
    public function isReadable($po_request, $ps_bundle_name=null)
    {
        ...
        if ($ps_bundle_name) {
            if ($po_request->user->getBundleAccessLevel('ca_object_representations', $ps_bundle_name) < __CA_BUNDLE_ACCESS_READONLY__) {
                return false;
            }
        }
        ...
        if ((defined("__CA_APP_TYPE__") && (__CA_APP_TYPE__ == "PAWTUCKET"))) {
            ...
            if (is_array($va_access) && sizeof($va_access) && !in_array($t_rep->get('access'), $va_access)) {
                return false;
            }
        }
    ...
    public function isSaveable($po_request, $ps_bundle_name=null)
    {
        ...
        if ($ps_bundle_name) {
            if ($po_request->user->getBundleAccessLevel('ca_object_representations', $ps_bundle_name) < __CA_BUNDLE_ACCESS_EDIT__) {
                return false;
            }
        }
