<?php
/** ---------------------------------------------------------------------
 * app/models/ca_entities_x_occurrences.php : table access class for table ca_entities_x_occurrences
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_entities_x_occurrences'] = array(
    'NAME_SINGULAR' 	=> _t('entity ⇔ occurrence relationship'),
    'NAME_PLURAL' 		=> _t('entity ⇔ occurrence relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_entities_x_occurrences extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_entities_x_occurrences';
    ...
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'entity_id';
