<?php
/** ---------------------------------------------------------------------
 * app/models/ca_object_representations_x_storage_locations.php : table access class for table ca_object_representations_x_storage_locations
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_object_representations_x_storage_locations'] = array(
    'NAME_SINGULAR' 	=> _t('object representation ⇔ storage location relationship'),
    'NAME_PLURAL' 		=> _t('object representation ⇔ storage location relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
        ...
        'location_id' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Location id', 'DESCRIPTION' => 'Identifier for storage location'
        ),
        'type_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
        ...
        'is_primary' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => _t('Is primary?'), 'DESCRIPTION' => _t('Indicates that the representation should be used to depict the storage location is situations where only a single representation can be displayed (eg. search results).')
        ),
        'rank' => array(
...
class ca_object_representations_x_storage_locations extends BaseRepresentationRelationship
{
    ...
    protected $TABLE = 'ca_object_representations_x_storage_locations';
