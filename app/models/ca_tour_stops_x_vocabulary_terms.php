<?php
/** ---------------------------------------------------------------------
 * app/models/ca_tour_stops_x_vocabulary_terms.php : table access class for table ca_tour_stops_x_vocabulary_terms
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_tour_stops_x_vocabulary_terms'] = array(
    'NAME_SINGULAR' 	=> _t('tour stop ⇔ vocabulary term relationship'),
    'NAME_PLURAL' 		=> _t('tour stop ⇔ vocabulary term relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_tour_stops_x_vocabulary_terms extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_tour_stops_x_vocabulary_terms';
