<?php
/** ---------------------------------------------------------------------
 * app/models/ca_entities_x_vocabulary_terms.php : table access class for table ca_entities_x_vocabulary_terms
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_entities_x_vocabulary_terms'] = array(
    'NAME_SINGULAR' 	=> _t('entity ⇔ vocabulary term relationship'),
    'NAME_PLURAL' 		=> _t('entity ⇔ vocabulary term relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_entities_x_vocabulary_terms extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_entities_x_vocabulary_terms';
