<?php
/** ---------------------------------------------------------------------
 * app/models/ca_movements_x_object_representations.php : table access class for table ca_movements_x_object_representations
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_movements_x_object_representations'] = array(
    'NAME_SINGULAR' 	=> _t('movements ⇔ representations relationship'),
    'NAME_PLURAL' 		=> _t('movements ⇔ representations relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_movements_x_object_representations extends BaseRepresentationRelationship
{
    ...
    protected $TABLE = 'ca_movements_x_object_representations';
