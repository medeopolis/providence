...
class ca_object_checkouts extends BundlableLabelableBaseModelWithAttributes
{
    ...
    {
        if (!$this->ops_transaction_uuid) {
            $this->ops_transaction_uuid = caGenerateGUID();
        }
     ...
     *
     */
    public static function getObjectCheckoutConfigForType($pm_type_id)
    {
    ...
    public function objectHasReservations($pn_object_id, $pa_options=null)
    {
        ...
        if (!sizeof($va_checkout_ids)) {
            return array();
        }

        if (!($qr_history = caMakeSearchResult('ca_object_checkouts', $va_checkout_ids))) {
            return array();
        }
     ...
     *
     */
    public static function getCurrentCheckoutInstance($pn_object_id, $pa_options=null)
    {
     ...
     * @return array
     */
    public static function getObjectIDsForOutstandingCheckouts($ps_datetime=null, $pa_options=null)
    {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
            $o_db = new Db();
        }
     ...
     * @return array
     */
    public static function getObjectIDsForCheckins($ps_datetime=null, $pa_options=null)
    {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
            $o_db = new Db();
        }
     ...
     * @return array
     */
    public static function getObjectIDsForReservations($pa_options=null)
    {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
            $o_db = new Db();
        }
     ...
     * @return array
     */
    public static function getOutstandingCheckoutsForUser($pn_user_id, $ps_display_template=null, $ps_datetime=null, $pa_options=null)
    {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
            $o_db = new Db();
        }
     ...
     * @return array
     */
    public static function getOverdueCheckoutsForUser($pn_user_id, $ps_display_template=null, $ps_datetime=null, $pa_options=null)
    {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
            $o_db = new Db();
        }
     ...
     * @return array
     */
    public static function getCheckinsForUser($pn_user_id, $ps_display_template=null, $ps_datetime=null, $pa_options=null)
    {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
            $o_db = new Db();
        }
     ...
     * @return int
     */
    public static function numOutstandingCheckouts($ps_datetime=null, $pa_options=null)
    {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
            $o_db = new Db();
        }
     ...
     * @return int
     */
    public static function outstandingCheckoutUserList($ps_datetime=null, $pa_options=null)
    {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
            $o_db = new Db();
        }
     ...
     * @return int
     */
    public static function numCheckins($ps_datetime=null, $pa_options=null)
    {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
            $o_db = new Db();
        }
     ...
     * @return int
     */
    public static function checkinUserList($ps_datetime=null, $pa_options=null)
    {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
            $o_db = new Db();
        }
     ...
     * @return int
     */
    public static function numOverdueCheckouts($ps_datetime=null, $pa_options=null)
    {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
            $o_db = new Db();
        }
     ...
     * @return int
     */
    public static function numOutstandingReservations($pa_options=null)
    {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
            $o_db = new Db();
        }
     ...
     * @return int
     */
    public static function reservationUserList($pa_options=null)
    {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
            $o_db = new Db();
        }
     ...
     *
     */
    public static function getDashboardStatistics($ps_datetime=null, $pa_options=null)
    {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
            $o_db = new Db();
        }
        if (!$ps_datetime) {
            $ps_datetime = _t('today');
        }
     ...
     *
     */
    public static function getItemsDueWithin($ps_interval, $pa_options=null)
    {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
            $o_db = new Db();
        }
        ...
        if ($ps_notification_interval) {
            if (($vn_notification_interval = (int)(strtotime($ps_notification_interval) - time())) < 0) {
                $vn_notification_interval = 0;
            }
        }
     ...
     *
     */
    public static function getOverdueItems($pa_options=null)
    {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
            $o_db = new Db();
        }
     ...
     *
     */
    public static function getReservedAvailableItems($pa_options=null)
    {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
            $o_db = new Db();
        }
        ...
        while ($qr_res->nextRow()) {
            ...
            if (isset($va_objects_seen[$va_row['object_id']]) && $va_objects_seen[$va_row['object_id']]) {
                continue;
            }
