<?php
/** ---------------------------------------------------------------------
 * app/models/ca_objects_x_places.php : table access class for table ca_objects_x_places
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_objects_x_places'] = array(
    'NAME_SINGULAR' 	=> _t('object ⇔ place relationship'),
    'NAME_PLURAL' 		=> _t('object ⇔ place relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_objects_x_places extends ObjectRelationshipBaseModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_objects_x_places';
