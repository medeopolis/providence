<?php
/** ---------------------------------------------------------------------
 * app/models/ca_object_representations_x_object_representations.php : table access class for table ca_object_representations_x_object_representations
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_object_representations_x_object_representations'] = array(
    ...
    'FIELDS' 			=> array(
        ...
        'representation_left_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Representation left id', 'DESCRIPTION' => 'Representation left id'
        ),
        'representation_right_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Representation right id', 'DESCRIPTION' => 'Representation right id'
        ),
        'type_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
...
class ca_object_representations_x_object_representations extends BaseRelationshipModel
{
    ...
    protected $LOG_CHANGES_USING_AS_SUBJECT = array(
        "FOREIGN_KEYS" => array(
            'representation_left_id', 'representation_right_id'
        ),
    ...
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'representation_left_id';
    protected $RELATIONSHIP_RIGHT_FIELDNAME = 'representation_right_id';
