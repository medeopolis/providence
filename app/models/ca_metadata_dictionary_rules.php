...
class ca_metadata_dictionary_rules extends BaseModel
{
    ...
    # ------------------------------------------------------
    public function __construct($id=null, ?array $options=null, $additional_settings=null, $setting_values=null)
    {
     ...
     */
    public static function getRules($options=null)
    {
        if (!($o_db = caGetOption('db', $options, null))) {
            $o_db = new Db();
        }
