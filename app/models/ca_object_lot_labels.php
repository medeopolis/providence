<?php
/** ---------------------------------------------------------------------
 * app/models/ca_object_lot_labels.php : table access class for table ca_object_lot_labels
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_object_lot_labels'] = array(
    ...
    'FIELDS' 			=> array(
        ...
        'type_id' => array(
                ...
                'LIST_CODE' => 'object_lot_label_types',
...
class ca_object_lot_labels extends BaseLabel
{
    ...
    protected $LABEL_SUBJECT_TABLE = 'ca_object_lots';
