<?php
/** ---------------------------------------------------------------------
 * app/models/ca_representation_annotations_x_occurrences.php : table access class for table ca_representation_annotations_x_occurrences
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_representation_annotations_x_occurrences'] = array(
    'NAME_SINGULAR' 	=> _t('representation annotation ⇔ occurrence relationship'),
    'NAME_PLURAL' 		=> _t('representation annotation ⇔ occurrence relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_representation_annotations_x_occurrences extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_representation_annotations_x_occurrences';
    ...
    # --- Relationship info
    # ------------------------------------------------------
    protected $RELATIONSHIP_LEFT_TABLENAME = 'ca_representation_annotations';
    protected $RELATIONSHIP_RIGHT_TABLENAME = 'ca_occurrences';
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'annotation_id';
