<?php
/** ---------------------------------------------------------------------
 * app/models/ca_places_x_occurrences.php : table access class for table ca_places_x_occurrences
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_places_x_occurrences'] = array(
    'NAME_SINGULAR' 	=> _t('place ⇔ occurrence relationship'),
    'NAME_PLURAL' 		=> _t('place ⇔ occurrence relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_places_x_occurrences extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_places_x_occurrences';
    ...
    # --- Relationship info
    # ------------------------------------------------------
    protected $RELATIONSHIP_LEFT_TABLENAME = 'ca_places';
    protected $RELATIONSHIP_RIGHT_TABLENAME = 'ca_occurrences';
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'place_id';
