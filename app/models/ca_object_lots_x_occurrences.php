<?php
/** ---------------------------------------------------------------------
 * app/models/ca_object_lots_x_occurrences.php : table access class for table ca_object_lots_x_occurrences
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_object_lots_x_occurrences'] = array(
    'NAME_SINGULAR' 	=> _t('object lot ⇔ occurrence relationship'),
    'NAME_PLURAL' 		=> _t('object lot ⇔ occurrence relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_object_lots_x_occurrences extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_object_lots_x_occurrences';
    ...
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'lot_id';
