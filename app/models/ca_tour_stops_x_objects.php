<?php
/** ---------------------------------------------------------------------
 * app/models/ca_tour_stops_x_objects.php : table access class for table ca_tour_stops_x_objects
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_tour_stops_x_objects'] = array(
    'NAME_SINGULAR' 	=> _t('tour stop ⇔ objects relationship'),
    'NAME_PLURAL' 		=> _t('tour stop ⇔ objects relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_tour_stops_x_objects extends ObjectRelationshipBaseModel
{
    ...
    protected $TABLE = 'ca_tour_stops_x_objects';
