<?php
/** ---------------------------------------------------------------------
 * app/models/ca_object_representations_x_entities.php : table access class for table ca_object_representations_x_entities
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_object_representations_x_entities'] = array(
    'NAME_SINGULAR' 	=> _t('object representation ⇔ entity relationship'),
    'NAME_PLURAL' 		=> _t('object representation ⇔ entity relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_object_representations_x_entities extends BaseRepresentationRelationship
{
    ...
    protected $TABLE = 'ca_object_representations_x_entities';
