<?php
/** ---------------------------------------------------------------------
 * app/models/ca_tour_stops_x_entities.php : table access class for table ca_tour_stops_x_entities
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_tour_stops_x_entities'] = array(
    'NAME_SINGULAR' 	=> _t('tour stop ⇔ entity relationship'),
    'NAME_PLURAL' 		=> _t('tour stop ⇔ entity relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_tour_stops_x_entities extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_tour_stops_x_entities';
