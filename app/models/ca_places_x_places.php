<?php
/** ---------------------------------------------------------------------
 * app/models/ca_places_x_places.php : table access class for table ca_places_x_places
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_places_x_places'] = array(
    'NAME_SINGULAR' 	=> _t('place ⇔ place relationship'),
    'NAME_PLURAL' 		=> _t('place ⇔ place relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
        ...
        'place_left_id' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Place left id', 'DESCRIPTION' => 'Place left id'
        ),
        'place_right_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
                'IS_NULL' => false,
                'DEFAULT' => '',
...
class ca_places_x_places extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_places_x_places';
    ...
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'place_left_id';
    protected $RELATIONSHIP_RIGHT_FIELDNAME = 'place_right_id';
