<?php
/** ---------------------------------------------------------------------
 * app/models/ca_places_x_storage_locations.php : table access class for table ca_places_x_storage_locations
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_places_x_storage_locations'] = array(
    ...
    'NAME_PLURAL' 		=> _t('places ⇔ storage locations relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_places_x_storage_locations extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_places_x_storage_locations';
