<?php
/** ---------------------------------------------------------------------
 * app/models/ca_storage_locations_x_storage_locations.php : table access class for table ca_storage_locations_x_storage_locations
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_storage_locations_x_storage_locations'] = array(
    'NAME_SINGULAR' 	=> _t('storage locations ⇔ storage locations relationship'),
    'NAME_PLURAL' 		=> _t('storage locations ⇔ storage locations relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
        ...
        'location_left_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Location left id', 'DESCRIPTION' => 'Location left id'
        ),
        'location_right_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Location right id', 'DESCRIPTION' => 'Location right id'
        ),
        'type_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
        ...
        'source_info' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => _t('Source notes'), 'DESCRIPTION' => _t('Source notes'),
...
class ca_storage_locations_x_storage_locations extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_storage_locations_x_storage_locations';
    ...
    protected $LOG_CHANGES_USING_AS_SUBJECT = array(
        "FOREIGN_KEYS" => array(
            'location_left_id', 'location_right_id'
        ),
    ...
    # --- Relationship info
    # ------------------------------------------------------
    protected $RELATIONSHIP_LEFT_TABLENAME = 'ca_storage_locations';
    protected $RELATIONSHIP_RIGHT_TABLENAME = 'ca_storage_locations';
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'location_left_id';
    protected $RELATIONSHIP_RIGHT_FIELDNAME = 'location_right_id';
