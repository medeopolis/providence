<?php
/** ---------------------------------------------------------------------
 * app/models/ca_object_lots_x_places.php : table access class for table ca_object_lots_x_places
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_object_lots_x_places'] = array(
    'NAME_SINGULAR' 	=> _t('object lot ⇔ place relationship'),
    'NAME_PLURAL' 		=> _t('object lot ⇔ place relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_object_lots_x_places extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_object_lots_x_places';
