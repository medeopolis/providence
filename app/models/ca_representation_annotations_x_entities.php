<?php
/** ---------------------------------------------------------------------
 * app/models/ca_representation_annotations_x_entities.php : table access class for table ca_representation_annotations_x_entities
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_representation_annotations_x_entities'] = array(
    'NAME_SINGULAR' 	=> _t('representation annotation ⇔ entity relationship'),
    'NAME_PLURAL' 		=> _t('representation annotation ⇔ entity relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_representation_annotations_x_entities extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_representation_annotations_x_entities';
    ...
    protected $RELATIONSHIP_RIGHT_TABLENAME = 'ca_entities';
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'annotation_id';
    protected $RELATIONSHIP_RIGHT_FIELDNAME = 'entity_id';
