<?php
/** ---------------------------------------------------------------------
 * app/models/ca_data_exporter_labels.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_data_exporter_labels'] = array(
    ...
    'FIELDS' 			=> array(
        ...
        'exporter_id' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Display id', 'DESCRIPTION' => 'Identifier for exporter'
        ),
        'name' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => _t('Name'), 'DESCRIPTION' => _t('Name of exporter'),
        ...
        'description' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => _t('Description'), 'DESCRIPTION' => _t('Description of exporter'),
        ...
        'locale_id' => array(
                ...
                'LABEL' => _t('Locale'), 'DESCRIPTION' => _t('Locale of exporter name'),
        ),
        'source_info' => array(
                'FIELD_TYPE' => FT_TEXT, 'DISPLAY_TYPE' => DT_FIELD,
...
class ca_data_exporter_labels extends BaseLabel
{
    # ---------------------------------
    ...
    protected $LABEL_SUBJECT_TABLE = 'ca_data_exporters';
