<?php
/** ---------------------------------------------------------------------
 * app/models/ca_movements_x_movements.php : table access class for table ca_movements_x_movements
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_movements_x_movements'] = array(
    'NAME_SINGULAR' 	=> _t('movement ⇔ movement relationship'),
    'NAME_PLURAL' 		=> _t('movement ⇔ movement relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
        ...
        'movement_left_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Movement left id', 'DESCRIPTION' => 'Movement left id'
        ),
        'movement_right_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
                'IS_NULL' => false,
                'DEFAULT' => '',
...
class ca_movements_x_movements extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_movements_x_movements';
    ...
    protected $LOG_CHANGES_USING_AS_SUBJECT = array(
        "FOREIGN_KEYS" => array(
            'movement_left_id', 'movement_right_id'
        ),
    ...
    protected $RELATIONSHIP_RIGHT_TABLENAME = 'ca_movements';
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'movement_left_id';
    protected $RELATIONSHIP_RIGHT_FIELDNAME = 'movement_right_id';
