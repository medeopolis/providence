<?php
/** ---------------------------------------------------------------------
 * app/models/ca_tour_stops_x_tour_stops.php : table access class for table ca_tour_stops_x_tour_stops
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_tour_stops_x_tour_stops'] = array(
    'NAME_SINGULAR' 	=> _t('tour stop ⇔ tour stop relationship'),
    'NAME_PLURAL' 		=> _t('tour stop ⇔ tour stop relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
        ...
        'stop_left_id' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Stop left id', 'DESCRIPTION' => 'Stop left id'
        ),
        'stop_right_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
...
class ca_tour_stops_x_tour_stops extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_tour_stops_x_tour_stops';
    ...
    protected $RELATIONSHIP_RIGHT_TABLENAME = 'ca_tour_stops';
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'stop_left_id';
    protected $RELATIONSHIP_RIGHT_FIELDNAME = 'stop_right_id';
