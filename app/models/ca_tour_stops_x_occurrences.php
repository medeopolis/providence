<?php
/** ---------------------------------------------------------------------
 * app/models/ca_tour_stops_x_occurrences.php : table access class for table ca_tour_stops_x_occurrences
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_tour_stops_x_occurrences'] = array(
    'NAME_SINGULAR' 	=> _t('tour stop ⇔ occurrence relationship'),
    'NAME_PLURAL' 		=> _t('tour stop ⇔ occurrence relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
        ...
        'stop_id' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Stop id', 'DESCRIPTION' => 'Identifier for tour stop'
        ),
        'type_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
...
class ca_tour_stops_x_occurrences extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_tour_stops_x_occurrences';
    ...
    # --- Relationship info
    # ------------------------------------------------------
    protected $RELATIONSHIP_LEFT_TABLENAME = 'ca_tour_stops';
    protected $RELATIONSHIP_RIGHT_TABLENAME = 'ca_occurrences';
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'stop_id';
