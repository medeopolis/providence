...
class ca_data_exporter_items extends BaseModel
{
    ...
    # ------------------------------------------------------
    public static function getReplacementArray($ps_searches, $ps_replacements)
    {
        if (!$ps_searches) {
            return false;
        }
    ...
    # ------------------------------------------------------
    public static function replaceText($ps_text, $pa_replacements)
    {
     ...
     *
     */
    public static function _processAppliedRegexes($value, $regexes)
    {
        if (is_array($regexes)) {
