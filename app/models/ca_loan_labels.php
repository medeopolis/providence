<?php
/** ---------------------------------------------------------------------
 * app/models/ca_loan_labels.php : table access class for table ca_loan_labels
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_loan_labels'] = array(
    'NAME_SINGULAR' 	=> _t('loan title'),
    'NAME_PLURAL' 		=> _t('loan titles'),
    'FIELDS' 			=> array(
        'label_id' => array(
...
class ca_loan_labels extends BaseLabel
{
    ...
    protected $TABLE = 'ca_loan_labels';
    ...
    protected $LABEL_SUBJECT_TABLE = 'ca_loans';
