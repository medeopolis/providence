<?php
/** ---------------------------------------------------------------------
 * app/models/ca_groups_x_roles.php : table access class for table ca_groups_x_roles
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_groups_x_roles'] = array(
    'NAME_SINGULAR' 	=> _t('group ⇔ role association'),
    'NAME_PLURAL' 		=> _t('group ⇔ role associations'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_groups_x_roles extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_groups_x_roles';
    ...
    # --- Relationship info
    # ------------------------------------------------------
    protected $RELATIONSHIP_LEFT_TABLENAME = 'ca_user_groups';
    protected $RELATIONSHIP_RIGHT_TABLENAME = 'ca_user_roles';
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'group_id';
