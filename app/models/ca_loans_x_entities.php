<?php
/** ---------------------------------------------------------------------
 * app/models/ca_loans_x_entities.php : table access class for table ca_loans_x_entities
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_loans_x_entities'] = array(
    'NAME_SINGULAR' 	=> _t('loans ⇔ entities relationship'),
    'NAME_PLURAL' 		=> _t('loans ⇔ entities relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_loans_x_entities extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_loans_x_entities';
