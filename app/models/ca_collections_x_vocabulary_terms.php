<?php
/** ---------------------------------------------------------------------
 * app/models/ca_collections_x_vocabulary_terms.php : table access class for table ca_collections_x_vocabulary_terms
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
class ca_collections_x_vocabulary_terms extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'collection_id';
