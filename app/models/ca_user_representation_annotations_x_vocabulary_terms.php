<?php
/** ---------------------------------------------------------------------
 * app/models/ca_user_representation_annotations_x_vocabulary_terms.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_user_representation_annotations_x_vocabulary_terms'] = array(
    'NAME_SINGULAR' 	=> _t('user representation annotation ⇔ vocabulary term relationship'),
    'NAME_PLURAL' 		=> _t('user representation annotation ⇔ vocabulary term relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_user_representation_annotations_x_vocabulary_terms extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_user_representation_annotations_x_vocabulary_terms';
