<?php
/** ---------------------------------------------------------------------
 * app/models/ca_loans_x_movements.php : table access class for table ca_loans_x_movements
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_loans_x_movements'] = array(
    'NAME_SINGULAR' 	=> _t('loans ⇔ movements relationship'),
    'NAME_PLURAL' 		=> _t('loans ⇔ movements relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_loans_x_movements extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_loans_x_movements';
    ...
    protected $RELATIONSHIP_RIGHT_FIELDNAME = 'movement_id';
