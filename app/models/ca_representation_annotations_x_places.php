<?php
/** ---------------------------------------------------------------------
 * app/models/ca_representation_annotations_x_places.php : table access class for table ca_representation_annotations_x_places
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_representation_annotations_x_places'] = array(
    'NAME_SINGULAR' 	=> _t('representation annotation ⇔ place relationship'),
    'NAME_PLURAL' 		=> _t('representation annotation ⇔ place relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_representation_annotations_x_places extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_representation_annotations_x_places';
    ...
    protected $RELATIONSHIP_RIGHT_TABLENAME = 'ca_places';
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'annotation_id';
    protected $RELATIONSHIP_RIGHT_FIELDNAME = 'place_id';
