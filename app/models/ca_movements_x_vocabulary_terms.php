<?php
/** ---------------------------------------------------------------------
 * app/models/ca_movements_x_vocabulary_terms.php : table access class for table ca_movements_x_vocabulary_terms
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_movements_x_vocabulary_terms'] = array(
    'NAME_SINGULAR' 	=> _t('movements ⇔ vocabulary terms relationship'),
    'NAME_PLURAL' 		=> _t('movements ⇔ vocabulary terms relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_movements_x_vocabulary_terms extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_movements_x_vocabulary_terms';
