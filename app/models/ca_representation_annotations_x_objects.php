<?php
/** ---------------------------------------------------------------------
 * app/models/ca_representation_annotations_x_objects.php : table access class for table ca_representation_annotations_x_objects
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_representation_annotations_x_objects'] = array(
    'NAME_SINGULAR' 	=> _t('representation annotation ⇔ object relationship'),
    'NAME_PLURAL' 		=> _t('representation annotation ⇔ object relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_representation_annotations_x_objects extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_representation_annotations_x_objects';
    ...
    protected $RELATIONSHIP_RIGHT_TABLENAME = 'ca_objects';
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'annotation_id';
    protected $RELATIONSHIP_RIGHT_FIELDNAME = 'object_id';
