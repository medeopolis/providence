...
class ca_data_importer_items extends BaseModel
{
        ...
        switch(sizeof($va_split)) {
            ...
            case 2:
                if (trim($va_split[0])==$t_instance->tableName()) {
                    ...
                    } elseif ($t_instance->isValidMetadataElement(trim($va_split[1]))) {
     ...
     *
     */
    public static function getAvailableRefineries()
    {
     ...
     *
     */
    public static function getRefinerySettings($ps_refinery)
    {
