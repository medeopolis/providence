<?php
/** ---------------------------------------------------------------------
 * app/models/ca_occurrence_labels.php : table access class for table ca_occurrence_labels
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_occurrence_labels'] = array(
    ...
    'FIELDS' 			=> array(
        ...
        'type_id' => array(
                ...
                'LIST_CODE' => 'occurrence_label_types',
...
class ca_occurrence_labels extends BaseLabel
{
    ...
    protected $LABEL_SUBJECT_TABLE = 'ca_occurrences';
