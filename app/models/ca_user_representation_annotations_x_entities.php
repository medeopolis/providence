<?php
/** ---------------------------------------------------------------------
 * app/models/ca_user_representation_annotations_x_entities.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_user_representation_annotations_x_entities'] = array(
    'NAME_SINGULAR' 	=> _t('user representation annotation ⇔ entity relationship'),
    'NAME_PLURAL' 		=> _t('user representation annotation ⇔ entity relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_user_representation_annotations_x_entities extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_user_representation_annotations_x_entities';
