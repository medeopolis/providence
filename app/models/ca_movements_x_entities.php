<?php
/** ---------------------------------------------------------------------
 * app/models/ca_movements_x_entities.php : table access class for table ca_movements_x_entities
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_movements_x_entities'] = array(
    'NAME_SINGULAR' 	=> _t('movements ⇔ entities relationship'),
    'NAME_PLURAL' 		=> _t('movements ⇔ entities relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_movements_x_entities extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_movements_x_entities';
