<?php
/** ---------------------------------------------------------------------
 * app/models/ca_storage_locations_x_vocabulary_terms.php : table access class for table ca_storage_locations_x_vocabulary_terms
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_storage_locations_x_vocabulary_terms'] = array(
    'NAME_SINGULAR' 	=> _t('storage locations ⇔ vocabulary terms relationship'),
    'NAME_PLURAL' 		=> _t('storage locations ⇔ vocabulary terms relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
        ...
        'item_id' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Vocabulary term id', 'DESCRIPTION' => 'Identifier for vocabulary term'
        ),
        'source_info' => array(
...
class ca_storage_locations_x_vocabulary_terms extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_storage_locations_x_vocabulary_terms';
    ...
    protected $RELATIONSHIP_RIGHT_TABLENAME = 'ca_list_items';
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'location_id';
