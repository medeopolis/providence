<?php
/** ---------------------------------------------------------------------
 * app/models/ca_metadata_alert_rules_x_users.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_metadata_alert_rules_x_users'] = array(
    'NAME_SINGULAR' 	=> _t('metadata alert rules ⇔ user association'),
    'NAME_PLURAL' 		=> _t('metadata alert rules ⇔ user associations'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_metadata_alert_rules_x_users extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_metadata_alert_rules_x_users';
