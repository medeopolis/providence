<?php
/* ----------------------------------------------------------------------
 * app/models/ca_object_representations_x_collections.php : table access class for table ca_object_representations_x_collections
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
class ca_object_representations_x_collections extends BaseRepresentationRelationship
{
    ...
    protected $TABLE = 'ca_object_representations_x_collections';
    ...
    protected $LOG_CHANGES_USING_AS_SUBJECT = array(
        "FOREIGN_KEYS" => array(
            'representation_id', 'collection_id'
        ),
