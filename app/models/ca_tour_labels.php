<?php
/** ---------------------------------------------------------------------
 * app/models/ca_tour_labels.php : table access class for table ca_tour_labels
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_tour_labels'] = array(
    'NAME_SINGULAR' 	=> _t('tour name'),
    'NAME_PLURAL' 		=> _t('tour names'),
    'FIELDS' 			=> array(
        'label_id' => array(
...
class ca_tour_labels extends BaseLabel
{
    ...
    protected $TABLE = 'ca_tour_labels';
    ...
    protected $LABEL_SUBJECT_TABLE = 'ca_tours';
