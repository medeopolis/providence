<?php
/** ---------------------------------------------------------------------
 * app/models/ca_editor_ui_labels.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_editor_ui_labels'] = array(
    ...
    'FIELDS' 			=> array(
        ...
        'name' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => _t('Name'), 'DESCRIPTION' => _t('Name of editor'),
        ...
        'description' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => _t('Description'), 'DESCRIPTION' => _t('Description of editor'),
...
class ca_editor_ui_labels extends BaseLabel
{
    ...
    protected $LABEL_SUBJECT_TABLE = 'ca_editor_uis';
