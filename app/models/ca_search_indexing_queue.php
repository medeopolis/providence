...
class ca_search_indexing_queue extends BaseModel
{
     ...
     * Path to lock file
     */
    public static $s_lock_filepath = __CA_APP_DIR__ . DIRECTORY_SEPARATOR . 'tmp' . DIRECTORY_SEPARATOR . __CA_APP_NAME__.'_search_indexing_queue.lock';

    /**
     * Lock time out. Locks older than this will be removed.
     */
    public static $s_lock_timeout = 60 * 60;   // in seconds
     ...
     *
     */
    public static function lockCanBeRemoved()
    {
