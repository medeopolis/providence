<?php
/** ---------------------------------------------------------------------
 * app/models/ca_list_items_x_list_items.php : table access class for table ca_list_items_x_list_items
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_list_items_x_list_items'] = array(
    'NAME_SINGULAR' 	=> _t('list item ⇔ list item relationship'),
    'NAME_PLURAL' 		=> _t('list item ⇔ list item relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
        ...
        'term_left_id' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Term left id', 'DESCRIPTION' => 'Term left id'
        ),
        'term_right_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
...
class ca_list_items_x_list_items extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_list_items_x_list_items';
    ...
    # --- Relationship info
    # ------------------------------------------------------
    protected $RELATIONSHIP_LEFT_TABLENAME = 'ca_list_items';
    protected $RELATIONSHIP_RIGHT_TABLENAME = 'ca_list_items';
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'term_left_id';
    protected $RELATIONSHIP_RIGHT_FIELDNAME = 'term_right_id';
