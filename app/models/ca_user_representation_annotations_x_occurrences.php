<?php
/** ---------------------------------------------------------------------
 * app/models/ca_user_representation_annotations_x_occurrences.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_user_representation_annotations_x_occurrences'] = array(
    'NAME_SINGULAR' 	=> _t('user representation annotation ⇔ occurrence relationship'),
    'NAME_PLURAL' 		=> _t('user representation annotation ⇔ occurrence relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_user_representation_annotations_x_occurrences extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_user_representation_annotations_x_occurrences';
    ...
    # --- Relationship info
    # ------------------------------------------------------
    protected $RELATIONSHIP_LEFT_TABLENAME = 'ca_user_representation_annotations';
