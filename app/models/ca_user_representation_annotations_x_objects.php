<?php
/** ---------------------------------------------------------------------
 * app/models/ca_user_representation_annotations_x_objects.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_user_representation_annotations_x_objects'] = array(
    'NAME_SINGULAR' 	=> _t('user representation annotation ⇔ object relationship'),
    'NAME_PLURAL' 		=> _t('user representation annotation ⇔ object relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_user_representation_annotations_x_objects extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_user_representation_annotations_x_objects';
