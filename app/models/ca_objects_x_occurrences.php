<?php
/** ---------------------------------------------------------------------
 * app/models/ca_objects_x_occurrences.php : table access class for table ca_objects_x_occurrences
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_objects_x_occurrences'] = array(
    'NAME_SINGULAR' 	=> _t('object ⇔ occurrence relationship'),
    'NAME_PLURAL' 		=> _t('object ⇔ occurrence relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_objects_x_occurrences extends ObjectRelationshipBaseModel
{
    ...
    protected $TABLE = 'ca_objects_x_occurrences';
