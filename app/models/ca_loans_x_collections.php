<?php
/** ---------------------------------------------------------------------
 * app/models/ca_loans_x_collections.php : table access class for table ca_loans_x_collections
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_loans_x_collections'] = array(
    'NAME_SINGULAR' 	=> _t('loans ⇔ collections relationship'),
    'NAME_PLURAL' 		=> _t('loans ⇔ collections relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_loans_x_collections extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_loans_x_collections';
