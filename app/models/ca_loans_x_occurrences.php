<?php
/** ---------------------------------------------------------------------
 * app/models/ca_loans_x_occurrences.php : table access class for table ca_loans_x_occurrences
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_loans_x_occurrences'] = array(
    'NAME_SINGULAR' 	=> _t('loans ⇔ occurrences relationship'),
    'NAME_PLURAL' 		=> _t('loans ⇔ occurrences relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_loans_x_occurrences extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_loans_x_occurrences';
