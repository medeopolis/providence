<?php
/** ---------------------------------------------------------------------
 * app/models/ca_occurrences_x_occurrences.php : table access class for table ca_occurrences_x_occurrences
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_occurrences_x_occurrences'] = array(
    'NAME_SINGULAR' 	=> _t('occurrence ⇔ occurrence relationship'),
    'NAME_PLURAL' 		=> _t('occurrence ⇔ occurrence relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
        ...
        'occurrence_left_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Occurrence left id', 'DESCRIPTION' => 'Occurrence left id'
        ),
        'occurrence_right_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
                'IS_NULL' => false,
                'DEFAULT' => '',
...
class ca_occurrences_x_occurrences extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_occurrences_x_occurrences';
    ...
    protected $LOG_CHANGES_USING_AS_SUBJECT = array(
        "FOREIGN_KEYS" => array(
            'occurrence_left_id', 'occurrence_right_id'
        ),
    ...
    # --- Relationship info
    # ------------------------------------------------------
    protected $RELATIONSHIP_LEFT_TABLENAME = 'ca_occurrences';
    protected $RELATIONSHIP_RIGHT_TABLENAME = 'ca_occurrences';
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'occurrence_left_id';
    protected $RELATIONSHIP_RIGHT_FIELDNAME = 'occurrence_right_id';
