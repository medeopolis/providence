...
class ca_metadata_dictionary_entries extends BundlableLabelableBaseModelWithAttributes
{
     ...
     */
    public static $s_definition_cache;

    /**
     * Index array converting bundle names to entry_id's
     */
    public static $s_definition_cache_index;

    /**
     * Index array converting bundle names to entry_id's
     */
    public static $s_definition_cache_relationship_type_ids;
     ...
     */
    public function __construct($id=null, ?array $options=null, $pa_additional_settings=null, $pa_setting_values=null)
    {
        parent::__construct($id, $options);

        //
        if (!is_array($pa_additional_settings)) {
            $pa_additional_settings = array();
        }
    ...
    /**
      ...
      */
    public static function preloadDefinitions($pa_bundles)
    {
        if (!is_array($pa_bundles) || !sizeof($pa_bundles)) {
            return null;
        }
    ...
    {
        if (!($entry_id = $this->getPrimaryKey())) {
            return null;
        }
