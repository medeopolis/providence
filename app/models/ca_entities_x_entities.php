<?php
/** ---------------------------------------------------------------------
 * app/models/ca_entities_x_entities.php : table access class for table ca_entities_x_entities
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_entities_x_entities'] = array(
    'NAME_SINGULAR' 	=> _t('entity ⇔ entity relationship'),
    'NAME_PLURAL' 		=> _t('entity ⇔ entity relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
        ...
        'entity_left_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Entity left id', 'DESCRIPTION' => 'Entity left id'
        ),
        'entity_right_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
                'IS_NULL' => false,
                'DEFAULT' => '',
...
class ca_entities_x_entities extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_entities_x_entities';
    ...
    protected $LOG_CHANGES_USING_AS_SUBJECT = array(
        "FOREIGN_KEYS" => array(
            'entity_left_id', 'entity_right_id'
        ),
    ...
    # --- Relationship info
    # ------------------------------------------------------
    protected $RELATIONSHIP_LEFT_TABLENAME = 'ca_entities';
    protected $RELATIONSHIP_RIGHT_TABLENAME = 'ca_entities';
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'entity_left_id';
    protected $RELATIONSHIP_RIGHT_FIELDNAME = 'entity_right_id';
