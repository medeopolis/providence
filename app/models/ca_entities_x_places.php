<?php
/** ---------------------------------------------------------------------
 * app/models/ca_entities_x_places.php : table access class for table ca_entities_x_places
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_entities_x_places'] = array(
    'NAME_SINGULAR' 	=> _t('entity ⇔ place relationship'),
    'NAME_PLURAL' 		=> _t('entity ⇔ place relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_entities_x_places extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_entities_x_places';
