<?php
/** ---------------------------------------------------------------------
 * app/models/ca_occurrences_x_vocabulary_terms.php : table access class for table ca_occurrences_x_vocabulary_terms
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_occurrences_x_vocabulary_terms'] = array(
    'NAME_SINGULAR' 	=> _t('occurrence ⇔ vocabulary term relationship'),
    'NAME_PLURAL' 		=> _t('occurrence ⇔ vocabulary term relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_occurrences_x_vocabulary_terms extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_occurrences_x_vocabulary_terms';
    ...
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'occurrence_id';
