<?php
/** ---------------------------------------------------------------------
 * app/models/ca_loans_x_storage_locations.php : table access class for table ca_loans_x_storage_locations
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_loans_x_storage_locations'] = array(
    'NAME_SINGULAR' 	=> _t('loans ⇔ storage locations relationship'),
    'NAME_PLURAL' 		=> _t('loans ⇔ storage locations relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_loans_x_storage_locations extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_loans_x_storage_locations';
