<?php
/** ---------------------------------------------------------------------
 * app/models/ca_objects_x_vocabulary_terms.php : table access class for table ca_objects_x_vocabulary_terms
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_objects_x_vocabulary_terms'] = array(
    'NAME_SINGULAR' 	=> _t('object ⇔ vocabulary term relationship'),
    'NAME_PLURAL' 		=> _t('object ⇔ vocabulary term relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_objects_x_vocabulary_terms extends ObjectRelationshipBaseModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_objects_x_vocabulary_terms';
