<?php
/** ---------------------------------------------------------------------
 * app/models/ca_occurrences_x_collections.php : table access class for table ca_occurrences_x_collections
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_occurrences_x_collections'] = array(
    'NAME_SINGULAR' 	=> _t('occurrence ⇔ collection relationship'),
    'NAME_PLURAL' 		=> _t('occurrence ⇔ collection relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_occurrences_x_collections extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_occurrences_x_collections';
