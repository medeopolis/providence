<?php
/** ---------------------------------------------------------------------
 * app/models/ca_movements_x_occurrences.php : table access class for table ca_movements_x_occurrences
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_movements_x_occurrences'] = array(
    'NAME_SINGULAR' 	=> _t('movements ⇔ occurrences relationship'),
    'NAME_PLURAL' 		=> _t('movements ⇔ occurrences relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_movements_x_occurrences extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_movements_x_occurrences';
