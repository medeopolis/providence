<?php
/** ---------------------------------------------------------------------
 * app/models/ca_objects_x_objects.php : table access class for table ca_objects_x_objects
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_objects_x_objects'] = array(
    'NAME_SINGULAR' 	=> _t('object ⇔ object relationship'),
    'NAME_PLURAL' 		=> _t('object ⇔ object relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
        ...
        'object_left_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Object left id', 'DESCRIPTION' => 'Object left id'
        ),
        'object_right_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
                'IS_NULL' => false,
                'DEFAULT' => '',
...
class ca_objects_x_objects extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_objects_x_objects';
    ...
    protected $LOG_CHANGES_USING_AS_SUBJECT = array(
        "FOREIGN_KEYS" => array(
            'object_left_id', 'object_right_id'
        ),
    ...
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'object_left_id';
    protected $RELATIONSHIP_RIGHT_FIELDNAME = 'object_right_id';
