<?php
/** ---------------------------------------------------------------------
 * app/models/ca_metadata_dictionary_entry_labels.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_metadata_dictionary_entry_labels'] = array(
    'NAME_SINGULAR' 	=> _t('data dictionary entry name'),
    'NAME_PLURAL' 		=> _t('data dictionary entry names'),
    'FIELDS' 			=> array(
        'label_id' => array(
        ...
        'entry_id' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Entry id', 'DESCRIPTION' => 'Identifier for dictionary entry'
        ),
        'locale_id' => array(
        ...
        'name' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => _t('Name'), 'DESCRIPTION' => _t('Name of dictionary entry'),
        ...
        'description' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => _t('Description'), 'DESCRIPTION' => _t('Description of entry'),
...
class ca_metadata_dictionary_entry_labels extends BaseLabel
{
    ...
    protected $TABLE = 'ca_metadata_dictionary_entry_labels';
    ...
    protected $LIST_HEADING = 'Data dictionary entry labels';

    # What you'd call a single record from this table (eg. a "person")
    protected $NAME_SINGULAR = 'data dictionary entry label';

    # What you'd call more than one record from this table (eg. "people")
    protected $NAME_PLURAL = 'data dictionary entry labels';
    ...
    protected $LABEL_SUBJECT_TABLE = 'ca_metadata_dictionary_entries';
