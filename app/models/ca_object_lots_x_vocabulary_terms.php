<?php
/** ---------------------------------------------------------------------
 * app/models/ca_object_lots_x_vocabulary_terms.php : table access class for table ca_object_lots_x_vocabulary_terms
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_object_lots_x_vocabulary_terms'] = array(
    'NAME_SINGULAR' 	=> _t('object lot ⇔ vocabulary term relationship'),
    'NAME_PLURAL' 		=> _t('object lot ⇔ vocabulary term relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_object_lots_x_vocabulary_terms extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_object_lots_x_vocabulary_terms';
