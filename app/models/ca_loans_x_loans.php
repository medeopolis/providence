<?php
/** ---------------------------------------------------------------------
 * app/models/ca_loans_x_loans.php : table access class for table ca_loans_x_loans
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_loans_x_loans'] = array(
    'NAME_SINGULAR' 	=> _t('loan ⇔ loan relationship'),
    'NAME_PLURAL' 		=> _t('loan ⇔ loan relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
        ...
        'loan_left_id' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Loan left id', 'DESCRIPTION' => 'Loan left id'
        ),
        'loan_right_id' => array(
                'FIELD_TYPE' => FT_NUMBER, 'DISPLAY_TYPE' => DT_FIELD,
                'DISPLAY_WIDTH' => 10, 'DISPLAY_HEIGHT' => 1,
...
class ca_loans_x_loans extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_loans_x_loans';
    ...
    protected $RELATIONSHIP_RIGHT_TABLENAME = 'ca_loans';
    protected $RELATIONSHIP_LEFT_FIELDNAME = 'loan_left_id';
    protected $RELATIONSHIP_RIGHT_FIELDNAME = 'loan_right_id';
