<?php
/** ---------------------------------------------------------------------
 * app/models/ca_movements_x_collections.php : table access class for table ca_movements_x_collections
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_movements_x_collections'] = array(
    'NAME_SINGULAR' 	=> _t('movements ⇔ collections relationship'),
    'NAME_PLURAL' 		=> _t('movements ⇔ collections relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_movements_x_collections extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_movements_x_collections';
