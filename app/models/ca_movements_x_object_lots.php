<?php
/** ---------------------------------------------------------------------
 * app/models/ca_movements_x_object_lots.php : table access class for table ca_movements_x_object_lots
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_movements_x_object_lots'] = array(
    'NAME_SINGULAR' 	=> _t('movements ⇔ object lots relationship'),
    'NAME_PLURAL' 		=> _t('movements ⇔ object lots relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
        ...
        'lot_id' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Object lot id', 'DESCRIPTION' => 'Identifier for Object lot'
        ),
        'source_info' => array(
...
class ca_movements_x_object_lots extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_movements_x_object_lots';
    ...
    protected $RELATIONSHIP_RIGHT_FIELDNAME = 'lot_id';
