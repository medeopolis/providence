...
class ca_locales extends BaseModel
{
     ...
     *
     */
    public static function getDefaultCataloguingLocaleID()
    {
     ...
     * @return areay
     */
    public static function getCataloguingLocaleList()
    {
     ...
     * @return areay
     */
    public static function getCataloguingLocaleCodes()
    {
     ...
     */
    public static function numberOfCataloguingLocales()
    {
     ...
     * @return int The locale_id of the locale, or null if the code is invalid
     */
    public static function codeToID($ps_code)
    {
        if (strlen($ps_code) == 0) {
            return null;
        }
     ...
     * @return string A language code in the form <language>_<country> (eg. en_US)
     */
    public static function IDToCode($pn_id)
    {
        if (strlen($pn_id) == 0) {
            return null;
        }
     ...
     * @return string The name of the locale
     */
    public static function IDToName($pn_id)
    {
        if (strlen($pn_id) == 0) {
            return null;
        }
     ...
     */
    public static function localesForLanguage($ps_language, $pa_options=null)
    {
