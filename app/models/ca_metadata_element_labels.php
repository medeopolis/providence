<?php
/** ---------------------------------------------------------------------
 * app/models/ca_metadata_element_labels.php : table access class for table ca_metadata_element_labels
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_metadata_element_labels'] = array(
    ...
    'FIELDS' 			=> array(
        ...
        'name' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => _t('Name'), 'DESCRIPTION' => _t('Name of element'),
...
class ca_metadata_element_labels extends BaseLabel
{
    ...
    protected $LABEL_SUBJECT_TABLE = 'ca_metadata_elements';
