<?php
/** ---------------------------------------------------------------------
 * app/models/ca_object_representations_x_places.php : table access class for table ca_object_representations_x_places
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_object_representations_x_places'] = array(
    ...
    'FIELDS' 			=> array(
        ...
        'is_primary' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => _t('Is primary?'), 'DESCRIPTION' => _t('Indicates that the representation should be used to depict the place is situations where only a single representation can be displayed (eg. search results).')
        ),
        'rank' => array(
...
class ca_object_representations_x_places extends BaseRepresentationRelationship
{
    ...
    protected $TABLE = 'ca_object_representations_x_places';
