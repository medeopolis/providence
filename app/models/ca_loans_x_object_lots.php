<?php
/** ---------------------------------------------------------------------
 * app/models/ca_loans_x_object_lots.php : table access class for table ca_loans_x_object_lots
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_loans_x_object_lots'] = array(
    'NAME_SINGULAR' 	=> _t('loans ⇔ object lots relationship'),
    'NAME_PLURAL' 		=> _t('loans ⇔ object lots relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_loans_x_object_lots extends BaseRelationshipModel
{
    ...
    protected $TABLE = 'ca_loans_x_object_lots';
