<?php
/** ---------------------------------------------------------------------
 * app/models/ca_set_item_labels.php : table access class for table ca_set_item_labels
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
class ca_set_item_labels extends BaseLabel
{
    ...
    protected $LIST_FIELDS = array('caption');
    ...
    protected $ORDER_BY = array('caption');
    ...
    protected $LABEL_DISPLAY_FIELD = 'caption';

    # --- Name of table this table contains label for
    protected $LABEL_SUBJECT_TABLE = 'ca_set_items';
