<?php
/** ---------------------------------------------------------------------
 * app/models/ca_data_importer_labels.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_data_importer_labels'] = array(
    ...
    'FIELDS' 			=> array(
        ...
        'importer_id' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => 'Display id', 'DESCRIPTION' => 'Identifier for importer'
        ),
        'name' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => _t('Name'), 'DESCRIPTION' => _t('Name of importer'),
        ...
        'description' => array(
                ...
                'IS_NULL' => false,
                'DEFAULT' => '',
                'LABEL' => _t('Description'), 'DESCRIPTION' => _t('Description of importer'),
...
class ca_data_importer_labels extends BaseLabel
{
    # ---------------------------------
    ...
    protected $LABEL_SUBJECT_TABLE = 'ca_data_importers';
