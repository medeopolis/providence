<?php
/** ---------------------------------------------------------------------
 * app/models/ca_loans_x_objects.php : table access class for table ca_loans_x_objects
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_loans_x_objects'] = array(
    'NAME_SINGULAR' 	=> _t('loans ⇔ objects relationship'),
    'NAME_PLURAL' 		=> _t('loans ⇔ objects relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_loans_x_objects extends ObjectRelationshipBaseModel
{
    ...
    protected $TABLE = 'ca_loans_x_objects';
