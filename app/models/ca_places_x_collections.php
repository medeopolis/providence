<?php
/** ---------------------------------------------------------------------
 * app/models/ca_places_x_collections.php : table access class for table ca_places_x_collections
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_places_x_collections'] = array(
    'NAME_SINGULAR' 	=> _t('place ⇔ collection relationship'),
    'NAME_PLURAL' 		=> _t('place ⇔ collection relationships'),
    'FIELDS' 			=> array(
        'relation_id' => array(
...
class ca_places_x_collections extends BaseRelationshipModel
{
    # ---------------------------------
    ...
    protected $TABLE = 'ca_places_x_collections';
