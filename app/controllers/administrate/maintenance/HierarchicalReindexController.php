<?php
/* ----------------------------------------------------------------------
 * app/controllers/administrate/maintenance/HierarchicalReindexController.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
class HierarchicalReindexController extends ActionController
{
    ...
    {
        $this->render('hierarchical_reindex_landing_html.php');
    }
    # ------------------------------------------------
    public function Reindex()
    {
        $this->render('hierarchical_reindex_status_html.php');
    }
    # ------------------------------------------------
}
