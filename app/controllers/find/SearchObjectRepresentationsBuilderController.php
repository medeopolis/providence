<?php
/* ----------------------------------------------------------------------
 * app/controllers/find/SearchObjectRepresentationsBuilderController.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
class SearchObjectRepresentationsBuilderController extends BaseSearchBuilderController
{
    # -------------------------------------------------------
    /**
