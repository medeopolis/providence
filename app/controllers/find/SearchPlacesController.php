<?php
/* ----------------------------------------------------------------------
 * app/controllers/find/SearchPlacesController.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
        ...
        return [
            [
                ...
                'requires' => [
                    ...
                    'checktypelimitinconfig:!ca_places_no_search_for_types:ca_places' => 'AND',
                    'configuration:!ca_places_disable_basic_search' => 'AND'
                ]
            ],
            [
                ...
                'requires' => [
                    ...
                    'checktypelimitinconfig:!ca_places_no_advanced_search_for_types:ca_places' => 'AND',
                    'configuration:!ca_places_disable_advanced_search' => 'AND'
                ]
            ],
            [
                'displayName' => _t('Search builder'),
                "default" => ['module' => 'find', 'controller' => 'SearchPlacesBuilder', 'action' => 'Index'],
                'useActionInPath' => 1,
                'parameters' => [
                    'type_id' => $pa_item['item_id'],
                    'reset' => $this->request->getUser()->getPreference('persistent_search')
                ],
                'is_enabled' => !$this->request->config->get('ca_places_disable_search_builder'),
                'requires' => [
                    'action:can_search_ca_places' => 'AND',
            ...
            [
                ...
                'is_enabled' => true,
                'requires' => [
                    'action:can_browse_ca_places' => 'AND',
                    'checktypelimitinconfig:!ca_places_no_browse_for_types:ca_places' => 'AND',
                    'configuration:!ca_places_disable_browse' => 'AND'
                ]
            ]
        ];
    }
