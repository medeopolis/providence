...
class RelatedListController extends BaseSearchController
{
    ...
    public function Index($pa_options=null)
    {
        ...
        if (!$t_subject || !$t_subject->load($vn_primary_id)) {
            throw new Exception(_t('Invalid table name'));
        }
    ...
    public function SaveUserSort()
    {
        ...
        if (!($t_related_rel_instance instanceof BaseRelationshipModel)) {
            return false;
        }
