<?php
/* ----------------------------------------------------------------------
 * app/controllers/find/SearchMovementsController.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
        ...
        return [
            [
                ...
                'requires' => [
                    ...
                    'checktypelimitinconfig:!ca_movements_no_search_for_types:ca_movements' => 'AND',
                    'configuration:!ca_movements_disable_basic_search' => 'AND'
                ]
            ],
            [
                ...
                'requires' => [
                    ...
                    'checktypelimitinconfig:!ca_movements_no_advanced_search_for_types:ca_movements' => 'AND',
                    'configuration:!ca_movements_disable_advanced_search' => 'AND'
                ]
            ],
            [
                'displayName' => _t('Search builder'),
                "default" => ['module' => 'find', 'controller' => 'SearchMovementsBuilder', 'action' => 'Index'],
                'useActionInPath' => 1,
                'parameters' => [
                    'type_id' => $pa_item['item_id'],
                    'reset' => $this->request->getUser()->getPreference('persistent_search')
                ],
                'is_enabled' => !$this->request->config->get('ca_movements_disable_search_builder'),
                'requires' => [
                    'action:can_search_ca_movements' => 'AND',
            ...
            [
                ...
                'is_enabled' => true,
                'requires' => [
                    'action:can_browse_ca_movements' => 'AND',
                    'checktypelimitinconfig:!ca_movements_no_browse_for_types:ca_movements' => 'AND',
                    'configuration:!ca_movements_disable_browse' => 'AND'
                ]
            ]
        ];
    }
