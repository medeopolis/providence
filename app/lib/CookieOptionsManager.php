...
class CookieOptionsManager
{
     ...
     *
     */
    public static function categoryExists(string $category)
    {
    ...
    {
        if (!self::cookieManagerEnabled()) {
            return false;
        }
        global $g_request;
        if ($g_request && strtolower($g_request->getController()) === 'cookies') {
            return false;
        }
     ...
     *
     */
    public static function allow(string $category)
    {
        if (!self::cookieManagerEnabled()) {
            return true;
        }
     ...
     *
     */
    public static function set(string $category, bool $allow)
    {
        if (!self::categoryExists($category)) {
            return null;
        }
     ...
     *
     */
    public static function cookieManagerEnabled()
    {
