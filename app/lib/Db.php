...
class Db extends DbBase
{
    ...
    {
        if (!$this->connected(true, "Db->prepare()")) {
            return false;
        }
        $this->clearErrors();
    ...
    {
        if (!$this->connected(true, "Db->query()")) {
            return false;
        }
        $this->clearErrors();
    ...
    {
        if (!$this->connected(true, "Db->getLastInsertID()")) {
            return false;
        }
    ...
    {
        if (!$this->connected(true, "Db->affectedRows()")) {
            return false;
        }
    ...
    {
        if (!$this->connected(true, "Db->escape()")) {
            return false;
        }
    ...
    {
        if (!$this->connected(true, "Db->beginTransaction()")) {
            return false;
        }
    ...
    {
        if (!$this->connected(true, "Db->commitTransaction()")) {
            return false;
        }
    ...
    {
        if (!$this->connected(true, "Db->rollbackTransaction()")) {
            return false;
        }
    ...
    {
        if (!$this->connected(true, "Db->supports()")) {
            return false;
        }
    ...
    {
        if (!$this->connected(true, "Db->getTables()")) {
            return false;
        }
    ...
    {
        if (!$this->connected(true, "Db->getFieldsFromTable()")) {
            return false;
        }
    ...
    {
        if (!$this->connected(true, "Db->getFieldInfo()")) {
            return false;
        }
    ...
    {
        if (!$this->connected(true, "Db->getIndices()")) {
            return false;
        }
