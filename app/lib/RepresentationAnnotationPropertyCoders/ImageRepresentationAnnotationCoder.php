<?php
/** ---------------------------------------------------------------------
 * app/lib/RepresentationAnnotationPropertyCoders/ImageRepresentationAnnotationCoder.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
                    ...
                    switch($va_property_info['displayType']) {
                        case 'DT_SELECT':
                            $vs_element = caHTMLMakeLabeledFormElement(
                                ...
                                $vs_label,
                                $pa_attributes['name'] ? $pa_attributes['name'] : $ps_property,
                                $va_property_info['description'],
                                $vs_format,
                                false
                            );
                            break;
