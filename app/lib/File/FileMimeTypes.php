...
class FileMimeTypes
{
     ...
     */
    public static function mimeTypeForFileExtension($ps_extension)
    {
        global $g_file_extensions_to_mimetypes;
     ...
     */
    public static function nameForMimeType($ps_mimetype)
    {
        global $g_mimetypes_to_info;
     ...
     */
    public static function nameForFileExtension($ps_extension)
    {
