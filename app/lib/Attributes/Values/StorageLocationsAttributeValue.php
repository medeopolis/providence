...
$_ca_attribute_settings['StorageLocationsAttributeValue'] = array(		// global
    'requireValue' => array(
        ...
        'description' => _t('Check this option if you want to require that a location be selected.')
    ),
    ...
    'restrictToTypes' => array(
        ...
        'useList' => 'storage_location_types',
        'width' => 35, 'height' => 5,
        'takesLocale' => false,
        'multiple' => 1,
        'default' => '',
...
class StorageLocationsAttributeValue extends AuthorityAttributeValue
{
    # ------------------------------------------------------------------
    /**
     ...
     */
    protected $ops_name_singular = 'StorageLocation';

    /**
     * Display name, in plural sense, of table this attribute references. The name should be capitalized.
     */
    protected $ops_name_plural = 'StorageLocations';
    # ------------------------------------------------------------------
    /**
     * Returns constant for storage locations attribute value
     *
