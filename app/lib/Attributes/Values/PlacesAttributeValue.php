<?php
/** ---------------------------------------------------------------------
 * app/lib/Attributes/Values/PlacesAttributeValue.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
$_ca_attribute_settings['PlacesAttributeValue'] = array(		// global
    'requireValue' => array(
        ...
        'description' => _t('Check this option if you want to require that a place be selected.')
    ),
...
class PlacesAttributeValue extends AuthorityAttributeValue
{
    # ------------------------------------------------------------------
    /**
     * Name of table this attribute references
     */
    protected $ops_table_name = 'ca_places';
