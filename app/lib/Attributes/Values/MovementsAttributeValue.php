<?php
/** ---------------------------------------------------------------------
 * app/lib/Attributes/Values/MovementsAttributeValue.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
$_ca_attribute_settings['MovementsAttributeValue'] = array(		// global
    'requireValue' => array(
        ...
        'description' => _t('Check this option if you want to require that a movement be selected.')
    ),
...
class MovementsAttributeValue extends AuthorityAttributeValue
{
    # ------------------------------------------------------------------
    /**
     ...
     */
    protected $ops_name_plural = 'Movements';
    # ------------------------------------------------------------------
    /**
     * Returns constant for movements attribute value
     *
