<?php
/** ---------------------------------------------------------------------
 * app/lib/Attributes/Values/CollectionsAttributeValue.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
$_ca_attribute_settings['CollectionsAttributeValue'] = array(		// global
    'requireValue' => array(
        ...
        'description' => _t('Check this option if you want to require that a collection be selected.')
    ),
    ...
    'doesNotTakeLocale' => array(
        ...
        'description' => _t('Check this option if you don\'t want your collection values to be locale-specific. (The default is to not be.)')
    ),
...
class CollectionsAttributeValue extends AuthorityAttributeValue
{
    # ------------------------------------------------------------------
    /**
