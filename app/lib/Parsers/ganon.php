...
{
    public const TOK_NULL = 0;
    public const TOK_UNKNOWN = 1;
    public const TOK_WHITESPACE = 2;
    public const TOK_IDENTIFIER = 3;
    public $doc = '';
    public $size = 0;
    public $pos = 0;
...
{
    public const TOK_TAG_OPEN = 100;
    public const TOK_TAG_CLOSE = 101;
    public const TOK_SLASH_FORWARD = 103;
    public const TOK_SLASH_BACKWARD = 104;
    public const TOK_STRING = 104;
    public const TOK_EQUALS = 105;
...
class HTML_Node
{
    public const NODE_ELEMENT = 0;
    public const NODE_TEXT = 1;
    public const NODE_COMMENT = 2;
    public const NODE_CONDITIONAL = 3;
    public const NODE_CDATA = 4;
    public const NODE_DOCTYPE = 5;
    public const NODE_XML = 6;
    public const NODE_ASP = 7;
    public const NODE_TYPE = self::NODE_ELEMENT;
...
{
    public const NODE_TYPE = self::NODE_TEXT;
    public $tag = '~text~';
    public $text = '';
...
{
    public const NODE_TYPE = self::NODE_COMMENT;
    public $tag = '~comment~';
    public $text = '';
    public function __construct($parent, $text = '')
    {
...
{
    public const NODE_TYPE = self::NODE_CONDITIONAL;
...
{
    public const NODE_TYPE = self::NODE_CDATA;
    public $tag = '~cdata~';
    public $text = '';
    public function __construct($parent, $text = '')
    {
...
{
    public const NODE_TYPE = self::NODE_DOCTYPE;
    public $tag = '!DOCTYPE';
    public $dtd = '';
...
{
    public const NODE_TYPE = self::NODE_XML;
...
{
    public const NODE_TYPE = self::NODE_ASP;
...
{
    public const TOK_BRACKET_OPEN = 100;
    public const TOK_BRACKET_CLOSE = 101;
    public const TOK_BRACE_OPEN = 102;
    public const TOK_BRACE_CLOSE = 103;
    public const TOK_STRING = 104;
    public const TOK_COLON = 105;
    public const TOK_COMMA = 106;
    public const TOK_NOT = 107;
    public const TOK_ALL = 108;
    public const TOK_PIPE = 109;
    public const TOK_PLUS = 110;
    public const TOK_SIBLING = 111;
    public const TOK_CLASS = 112;
    public const TOK_ID = 113;
    public const TOK_CHILD = 114;
    public const TOK_COMPARE_PREFIX = 115;
    public const TOK_COMPARE_CONTAINS = 116;
    public const TOK_COMPARE_CONTAINS_WORD = 117;
    public const TOK_COMPARE_ENDS = 118;
    public const TOK_COMPARE_EQUALS = 119;
    public const TOK_COMPARE_NOT_EQUAL = 120;
    public const TOK_COMPARE_BIGGER_THAN = 121;
    public const TOK_COMPARE_SMALLER_THAN = 122;
    public const TOK_COMPARE_REGEX = 123;
    public const TOK_COMPARE_STARTS = 124;
    public $identifiers = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890_-?';
    public $custom_char_map = array(
        '.' => self::TOK_CLASS,
        '#' => self::TOK_ID,
