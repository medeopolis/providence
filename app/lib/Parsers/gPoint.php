...
class gPoint
{
    ...
    */
    public $ellipsoid = array(//Ellipsoid name, Equatorial Radius, square of eccentricity
    ...
    // Properties
    public $a;										// Equatorial Radius
    public $e2;									// Square of eccentricity
    public $datum;									// Selected datum
    public $Xp;
    public $Yp;								// X,Y pixel location
    public $lat;
    public $long;							// Latitude & Longitude of the point
    public $utmNorthing;
    public $utmEasting;
    public $utmZone;	// UTM Coordinates of the point
    public $lccNorthing;
    public $lccEasting;				// Lambert coordinates of the point
    public $falseNorthing;
    public $falseEasting;			// Origin coordinates for Lambert Projection
    public $latOfOrigin;							// For Lambert Projection
    public $longOfOrigin;							// For Lambert Projection
    public $firstStdParallel;						// For lambert Projection
    public $secondStdParallel;						// For lambert Projection
    ...
    //
    public function setLambert($easting, $northing)
    {
...
//
    public function configLambertProjection(
        $falseEasting,
        $falseNorthing,
        $longOfOrigin,
        $latOfOrigin,
