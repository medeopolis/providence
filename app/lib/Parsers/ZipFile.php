...
class ZipFile
{
    ...
    public function __construct($tmp_dir=null)
    {
        ...
        $file_cleanup_list[] = $this->_tmp_data_path = tempnam($tmp_dir ? $tmp_dir : caGetTempDirPath(), "ZIP");
    ...
    public function addFile($data, $name, $time=0, $pa_options=null)
    {
        ...
        if ($this->debug) {
            print "DEBUG (ZipFile.php); addFile() START: ".memory_get_usage()."<br>\n";
        }
        ...
        if ($this->debug) {
            print "DEBUG (ZipFile.php); addFile() AFTER LOAD FILE: ".memory_get_usage()."<br>\n";
        }
