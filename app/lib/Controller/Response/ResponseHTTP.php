...
class ResponseHTTP extends Response
{
    ...
    {
        if (!isset($this->opa_headers[$ps_name]) || !is_array($this->opa_headers[$ps_name]) || $ps_replace) {
            $this->opa_headers[$ps_name] = array();
        }
    ...
    {
        if (!isset($this->opa_content[$ps_segment])) {
            $this->opa_content[$ps_segment] = '';
        }
        $this->opa_content[$ps_segment] .= $ps_content;
    }
    # -------------------------------------------------------
    ...
    {
        if ($this->opb_content_was_sent || headers_sent()) {
            return;
        }
