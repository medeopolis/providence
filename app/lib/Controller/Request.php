 ...
 * @return float Seconds elapsed since request started.
 */
    public function getParameter($ps_name, $pn_type)
    {
    ...
    # ----------------------------------------
    public function setParameter($ps_name, $ps_value)
    {
    ...
    # ----------------------------------------
    public function characterSetHeader()
    {
 ...
 */
    ...
    {
        if (!isset($this->opa_action_errors[$ps_source]) || !is_array($this->opa_action_errors[$ps_source])) {
            return array();
        }
    ...
    {
        if (!is_array($this->opa_action_errors[$ps_source])) {
            $this->opa_action_errors[$ps_source] = array();
        }

        if ($ps_subsource) {
            if (!is_array($this->opa_action_errors[$ps_source][$ps_subsource])) {
                $this->opa_action_errors[$ps_source][$ps_subsource] = array();
            }
