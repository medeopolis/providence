...
{
    # ------------------------------------------------
    public static $s_table_num_cache = array();
    public static $s_db;
    public static $s_index_insert;
    public static $s_index_delete;
    public static $s_index_find;
    public static $s_index_check;
    public static $s_autocomplete;
    public static $s_data = array();
    # ------------------------------------------------
    /**
     *
     */
    public static function index($pm_table, $pn_row_id, $ps_content, $pn_page, $pn_x1, $pn_y1, $pn_x2, $pn_y2)
    {
        MediaContentLocationIndexer::_init();
        if (!($pn_table = MediaContentLocationIndexer::_getTableNum($pm_table))) {
            return null;
        }
     ...
     *
     */
    public static function clear($pm_table, $pn_row_id)
    {
        MediaContentLocationIndexer::_init();
        MediaContentLocationIndexer::$s_data = array();
        if (!($pn_table = MediaContentLocationIndexer::_getTableNum($pm_table))) {
     ...
     *
     */
    public static function find($pm_table, $pn_row_id, $ps_content)
    {
        MediaContentLocationIndexer::_init();
        if (!($pn_table = MediaContentLocationIndexer::_getTableNum($pm_table))) {
            return null;
     ...
     *
     */
    public static function hasIndexing($pm_table, $pn_row_id)
    {
        MediaContentLocationIndexer::_init();
        if (!($pn_table = MediaContentLocationIndexer::_getTableNum($pm_table))) {
            return null;
     ...
     *
     */
    public static function _getTableNum($pm_table)
    {
     ...
     *
     */
    public static function searchWithinMedia($ps_query, $pm_table, $pn_row_id, $ps_field)
    {
     ...
     */
    public static function autocomplete($ps_q, $pm_table, $pn_row_id)
    {
        MediaContentLocationIndexer::_init();
        if (!($pn_table = MediaContentLocationIndexer::_getTableNum($pm_table))) {
            return null;
