...
class RecordSelection
{
     ...
     */
    public static function restore(array $serialized_data, array $options=null): ?RecordSelection
    {
        if (empty($serialized_data['id'])) {
            return null;
        }
        ...
        switch($type) {
            case 'ca_sets':
                ...
                break;
            case 'BatchEdit':
                if (!($ids = caGetOption('items', $serialized_data, null))) {
                    return null;
                }
