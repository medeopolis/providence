...
class MetaTagManager
{
     ...
     */
    public static function addMeta($ps_tag_name, $ps_content)
    {
     ...
     */
    public static function addMetaProperty($ps_tag_property, $ps_content)
    {
        if (!is_array(MetaTagManager::$opa_tags)) {
            MetaTagManager::init();
        }
     ...
     */
    public static function addLink($ps_rel, $ps_href, $ps_type=null)
    {
        if (!is_array(MetaTagManager::$opa_tags)) {
            MetaTagManager::init();
        }
     ...
     */
    public static function setWindowTitle($ps_title)
    {
