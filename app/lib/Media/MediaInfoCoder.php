...
class MediaInfoCoder
{
    ...
    {
        if (!($va_media_info = $this->opa_media_info) && !($va_media_info = caGetOption('data', $pa_options, null))) {
            return false;
        }
        ...
        if ($ps_version) {
            if (!$ps_key) {
                ...
                if ($v = $va_media_info[$ps_version][$ps_key]) {
                    return $v;
                }

                // Make case insensitive
                if ($v = $va_media_info[$ps_version][strtoupper($ps_key)]) {
                    return $v;
                }
                if ($v = $va_media_info[$ps_version][strtolower($ps_key)]) {
                    return $v;
                }
                return null;
            }
