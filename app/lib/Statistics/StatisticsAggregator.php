...
class StatisticsAggregator
{
     ...
     */
    public static function getAggregatedDataForGroup($group)
    {
     ...
     */
    public static function getDataForsite($site)
    {
        $data = PersistentCache::fetch('site_statistics', 'statistics');
     ...
     *
     */
    public static function getSitesForGroup($group)
    {
        $sites = self::getSites();
     ...
     *
     */
    public static function _addData($data, $acc)
    {
        foreach ($data as $k => $v) {
            if (in_array($k, ['access_statuses', 'groups'])) {
                continue;
            }
            if (is_array($v)) {
