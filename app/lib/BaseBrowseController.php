                            ...
                            case __CA_ATTRIBUTE_VALUE_LIST__:
                                ...
                                if ($qr_res) {
                                    ...
                                    while ($qr_res->nextHit()) {
                                        ...
                                        if (is_array($va_access_values) && !in_array($vn_access, $va_access_values)) {
                                            continue;
                                        }
                                        if (!is_array($va_ancestors) || !in_array($vn_item_id, $va_ancestors)) {
                                            continue;
                                        }
                    ...
                    if (!$vn_id) {
                        ...
                        if (is_array($va_hier_ids) && (sizeof($va_hier_ids) > 0) && $t_item) {
                            ...
                            foreach ($va_hierarchy_list as $vn_i => $va_item) {
                                ...
                                if (is_array($va_access_values) && isset($va_item['access']) && (!in_array($va_item['access'], $va_access_values))) {
                                    continue;
                                }
