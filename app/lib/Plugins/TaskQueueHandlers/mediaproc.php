                ...
                while (list($operation, $pa_parameters) = each($va_rules)) {
                    if ($operation === 'SET') {
                        ...
                        if (is_array($va_media_center = $t_instance->getMediaCenter($vs_field))) {
                            ...
                            if (($pa_parameters['_centerX'] < 0) || ($pa_parameters['_centerX'] > 1)) {
                                $pa_parameters['_centerX'] = 0.5;
                            }
                            if (($pa_parameters['_centerY'] < 0) || ($pa_parameters['_centerY'] > 1)) {
                                $pa_parameters['_centerY'] = 0.5;
                            }
                        }
