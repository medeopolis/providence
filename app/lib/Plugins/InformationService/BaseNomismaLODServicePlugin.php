...
abstract class BaseNomismaLODServicePlugin extends BaseInformationServicePlugin
{
    ...
    public function getDataForSearchIndexing($pa_settings, $ps_url)
    {
        ...
        if (!isset($va_service_conf['additional_indexing_info']) || !is_array($va_service_conf['additional_indexing_info'])) {
            return array();
        }
     ...
     * @return string|bool
     */
    public static function getLiteralFromRDFNode($ps_base_node, $ps_literal_property, $ps_node_uri=null, $pa_options=array())
    {
