...
class BaseXMLDataReader extends BaseDataReader
{
    ...
    public function read($ps_source, $pa_options=null)
    {
        ...
        if ($ps_source) {
            ...
            if (!($this->opo_xml = @DOMDocument::loadXML($str))) {
                return false;
            }
        } else {
            return false;
    ...
    {
        if (!($o_row = $this->opo_handle->item($this->opn_current_row))) {
            return false;
        }
    ...
    public function get($ps_spec, $pa_options=null)
    {
        ...
        if (!($o_node_list = $this->getXPath($ps_spec, $pa_options))) {
            return null;
        }
