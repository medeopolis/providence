...
class EADReader extends BaseXMLDataReader
{
    # -------------------------------------------------------
    /**
     ...
     */
    protected $ops_xml_namespace = 'http://ead3.archivists.org/schema/';
    ...
    public function __construct($ps_source=null, $pa_options=null)
    {
        ...
        $this->ops_title = _t('Encoded Archival Description Schema (EAD) XML Reader');
        $this->ops_display_name = _t('Encoded Archival Description Schema (EAD) XML');
