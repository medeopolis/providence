...
class MODSReader extends BaseXMLDataReader
{
    # -------------------------------------------------------
    /**
     ...
     */
    protected $ops_xml_namespace = 'http://www.loc.gov/mods/v3';
     ...
     */
    protected $ops_xml_namespace_prefix = 'mods';

    /**
     * XPath to select data for reading
     */
    protected $ops_xpath = '//mods:mods';

    /**
     *
     */
    protected $ops_root_tag = 'mods';
    ...
    public function __construct($ps_source=null, $pa_options=null)
    {
        ...
        $this->ops_title = _t('Metadata Object Description Schema (MODS) XML Reader');
        $this->ops_display_name = _t('Metadata Object Description Schema (MODS) XML');
        $this->ops_description = _t('Reads Metadata Object Description Schema (MODS) XML files');

        $this->opa_formats = array('mods');	// must be all lowercase to allow for case-insensitive matching
    }
    # -------------------------------------------------------
}
