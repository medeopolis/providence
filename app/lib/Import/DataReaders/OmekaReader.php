...
class OmekaReader extends BaseXMLDataReader
{
    # -------------------------------------------------------
    /**
     ...
     */
    protected $ops_xml_namespace = 'http://omeka.org/schemas/omeka-xml/v5';
     ...
     */
    protected $ops_xml_namespace_prefix = 'x';
    ...
    public function __construct($ps_source=null, $pa_options=null)
    {
        ...
        $this->opa_formats = array('omeka');	// must be all lowercase to allow for case-insensitive matching
    }
    # -------------------------------------------------------
}
