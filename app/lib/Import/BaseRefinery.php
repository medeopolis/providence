...
abstract class BaseRefinery
{
     ...
     *
     */
    public static $s_refinery_settings = array();
     ...
     */
    abstract public function refine(&$pa_destination_data, $pa_group, $pa_item, $pa_source_data, $pa_options=null);
    # -------------------------------------------------------
    /**
     ...
     */
    abstract public function returnsMultipleValues();
    # -------------------------------------------------------
    /**
     *
     *
