...
class DbResult extends DbBase
{
     ...
     * @access private
     */
    public static $s_field_info_cache;
     ...
     */
    public function __construct(&$po_db, $pr_res)
    {
     ...
     * @return mixed
     */
    public function &getFieldAtIndex($pn_i, $pa_options=null)
    {
    ...
    {
        if (isset(DbResult::$s_field_info_cache[$ps_field])) {
            return DbResult::$s_field_info_cache[$ps_field];
        }
     ...
     * @return array
     */
    public function getMediaInfo($ps_field, $ps_version=null, $ps_key=null)
    {
