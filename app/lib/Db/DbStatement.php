...
class DbStatement extends DbBase
{
     ...
     * @access private
     */
    public $opn_last_insert_id = null;
     ...
     *
     */
    public $opo_native_statement = null;
     ...
     */
    public function __construct($po_db, $ps_sql, $po_options=null)
    {
        $this->opo_db = $po_db;
        $this->ops_sql = $ps_sql;
     ...
     */
    public function executeWithParamsAsArray($pa_params, $pa_options=null)
    {
        $this->clearErrors();
     ...
     */
    public function setLimit($pn_limit, $pn_offset=0)
    {
