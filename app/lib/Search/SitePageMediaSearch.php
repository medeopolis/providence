<?php
/** ---------------------------------------------------------------------
 * app/lib/Search/SitePageMediaSearch.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
class SitePageMediaSearch extends BaseSearch
{
     ...
     */
    protected $ops_tablename = "ca_site_page_media";
    protected $ops_primary_key = "media_id";

    # ----------------------------------------------------------------------
    public function &search($ps_search, $pa_options=null)
    {
        return parent::doSearch($ps_search, new SitePageMediaSearchResult(), $pa_options);
    }
    # ----------------------------------------------------------------------
}
