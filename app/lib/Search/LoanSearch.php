...
include_once(__CA_LIB_DIR__."/Search/LoanSearchResult.php");

class LoanSearch extends BaseSearch
{
    /**
    ...
    {
        return parent::doSearch($ps_search, new LoanSearchResult(), $pa_options);
    }
    # ----------------------------------------------------------------------
}
