<?php
/** ---------------------------------------------------------------------
 * app/lib/Search/SearchConfigurationSettings.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
abstract class ASearchConfigurationSettings
{
    ...
    # ------------------------------------------------
    abstract public function setSettings(); // is supposed to have side-effect on opa_possible_errors property!
    # ------------------------------------------------
    abstract public function checkSetting($pn_setting_num);
    # ------------------------------------------------
    abstract public function getSettingDescription($pn_setting_num);
    abstract public function getSettingName($pn_setting_num);
    abstract public function getSettingHint($pn_setting_num);
    # ------------------------------------------------
}
# ------------------------------------------------
