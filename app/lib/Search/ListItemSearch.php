<?php
/** ---------------------------------------------------------------------
 * app/lib/Search/ListItemSearch.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
include_once(__CA_LIB_DIR__."/Search/ListItemSearchResult.php");

class ListItemSearch extends BaseSearch
{
    # ----------------------------------------------------------------------
    /**
    ...
    {
        return parent::doSearch($ps_search, new ListItemSearchResult(), $pa_options);
    }
    # ----------------------------------------------------------------------
}
