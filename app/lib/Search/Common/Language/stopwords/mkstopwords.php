<?php
    ...
    #
    # Script to generate serialized language-specific stop word lists
    #
    # Each key in the $va_stopwords array is a language abbreviation; the value is an array of stop words for that language
    # This script generates lang.inc files (ex. "en.inc" for English) for each language listed here containing a serialized array of words
    #
    ...
    $va_stopwords = array(
        ...
        "de" => array(
            ...
            "jetzt", "kann", "kein", "keine", "keinem", "keinen", "keiner", "keines", "können",
        ...
        "es" => array(
            ...
            "vosostros", "vosostras", "os", "mío", "mía", "míos", "mías", "tuyo", "tuya", "tuyos",
        ...
        "it" => array(
            ...
            "avuto", "avuta", "avuti", "avute", "sono", "sei", "è", "siamo", "siete", "sia", "siate", "siano",
            "sarò", "sarai", "sarà", "saremo", "sarete", "saranno", "sarei", "saresti", "sarebbe",
            ...
            "stia", "stiate", "stiano", "starò", "starai", "starà", "staremo", "starete",
    ...
    # Generate files
    #
    foreach ($va_stopwords as $vs_lang => $va_stopword_list) {
        $r_fp = fopen("./$vs_lang.inc", "w");
        fputs($r_fp, serialize($va_stopword_list));
        fclose($r_fp);
    }
