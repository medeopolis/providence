...
class WidgetManager
{
     ...
     */
    public static $s_widget_manager_did_do_widget_init = false;

    /**
     *
     */
    public static $s_widget_instances = array();
    /**
     *
     */
    public static $s_widget_hooks = array();
    # -------------------------------------------------------
    ...
    {
        if (WidgetManager::$s_widget_manager_did_do_widget_init) {
            return true;
        }
    ...
    {
        $o_config = Configuration::load();
        if (!($vs_base_widget_dir = $o_config->get('dashboard_widgets'))) {
            return array();
        }
    ...
    public static function getWidgetRoleActions()
    {
        ...
        CompositeCache::save('role_action_list', $va_actions, 'WidgetManager', 3600 * 24 * 30);
        return $va_actions;
    }
    # -------------------------------------------------------
    /**
