<?php
/** ---------------------------------------------------------------------
 * app/lib/Browse/TourBrowse.php : ca_places faceted browse
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
require_once(__CA_LIB_DIR__.'/Browse/TourBrowseResult.php');

class TourBrowse extends BaseBrowse
{
    # ------------------------------------------------------
    /**
    ...
    protected $ops_primary_key = "tour_id";
    # ----------------------------------------------------------------------
    ...
    {
        return parent::doGetResults(new TourBrowseResult(), $pa_options);
    }
    # ----------------------------------------------------------------------
}
