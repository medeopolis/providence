<?php
/** ---------------------------------------------------------------------
 * app/lib/Browse/TourStopBrowse.php : ca_places faceted browse
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
require_once(__CA_LIB_DIR__.'/Browse/TourStopBrowseResult.php');

class TourStopBrowse extends BaseBrowse
{
    # ------------------------------------------------------
    /**
    ...
    protected $ops_primary_key = "stop_id";
    # ----------------------------------------------------------------------
    ...
    {
        return parent::doGetResults(new TourStopBrowseResult(), $pa_options);
    }
    # ----------------------------------------------------------------------
}
