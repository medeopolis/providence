...
class TooltipManager
{
     ...
     */
    public static function add($ps_dom_selector, $ps_content, $ps_namespace='default')
    {
     ...
     * @return (bool) - Returns true if tooltip was successfully added, false if not
     */
    public static function addFunction($ps_dom_selector, $ps_code, $ps_namespace='default')
    {
        if (!is_array(TooltipManager::$opa_tooltips)) {
            TooltipManager::init();
        }
     ...
     * @return void
     */
    public static function setNamespaceCSSClass($ps_namespace, $ps_class)
    {
     ...
     */
    public static function getLoadHTML($ps_namespace='default')
    {
        if (!$ps_namespace) {
            $ps_namespace = 'default';
        }
