...
abstract class BaseTestWithData extends TestCase
{
    ...
    public static $opa_valid_tables = array('ca_objects', 'ca_entities', 'ca_occurrences', 'ca_movements', 'ca_loans', 'ca_object_lots', 'ca_storage_locations', 'ca_places', 'ca_item_comments', 'ca_sets');
    # -------------------------------------------------------
    /**
