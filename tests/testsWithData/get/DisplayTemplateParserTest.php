...
class DisplayTemplateParserTest extends BaseTestWithData
{
    ...
    public function testFormatsWithRequireLinkTagsOption()
    {
        ...
        $this->assertIsArray($vm_ret);
        $this->assertCount(1, $vm_ret);
        $this->assertStringContainsString("editor/objects/ObjectEditor/Summary/object_id/{$this->opn_object_id}/rel/1\">My test image</a> (TEST.1)", $vm_ret[0]);
        ...
        $this->assertIsArray($vm_ret);
        $this->assertCount(1, $vm_ret);
        $this->assertStringContainsString("editor/objects/ObjectEditor/Summary/object_id/{$this->opn_object_id}/rel/1'>URL: My test image (TEST.1)</a>", $vm_ret[0]);
    }
    # -------------------------------------------------------
    ...
    public function testTemplateWithNewLines()
    {
        ...
        $this->assertStringContainsString("/MultiSearch/Index/search/ca_entities.entity_id:".$this->opn_entity_id1."\">Homer J. Simpson</a>", $vm_ret[0]);
        $this->assertStringContainsString("/MultiSearch/Index/search/ca_entities.entity_id:".$this->opn_entity_id2."\">Bart Simpson</a>", $vm_ret[0]);
        ...
        $this->assertIsArray($vm_ret);
        $this->assertCount(1, $vm_ret);
        $this->assertStringContainsString("editor/entities/EntityEditor/Summary/entity_id/".$this->opn_entity_id1."/rel/1\">Homer J. Simpson</a>", $vm_ret[0]);
        $this->assertStringContainsString("editor/entities/EntityEditor/Summary/entity_id/".$this->opn_entity_id2."/rel/1\">Bart Simpson</a>", $vm_ret[0]);
        $this->assertStringContainsString('<img src="left2.png" /><strong>Related people</strong><img src="right2.png" />', $vm_ret[0]);
