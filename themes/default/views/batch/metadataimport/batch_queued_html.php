<?php
/* ----------------------------------------------------------------------
 * views/batch/metadataimport/batch_queued_html.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
?>
<h1><?php print _t('Metadata import queued for background processing'); ?></h1>

<div class="batchProcessingHelpText">
<?php
    print _t('Your metadata import has been queued and will be run shortly. You may continue to work while the import is processed.');
