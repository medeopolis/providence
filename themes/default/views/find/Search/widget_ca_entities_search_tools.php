<?php
/* ----------------------------------------------------------------------
 * themes/default/views/find/Search/widget_ca_entities_search_tools.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
<h3 class="tools"><?php print _t("History"); ?>:
	<div>
<?php
            print caFormTag($this->request, 'Index', 'caSearchHistoryForm', 'find/SearchEntities', 'post', 'multipart/form-data', '_top', array('noCSRFToken' => true, 'disableUnsavedChangesWarning' => true));
...
if (sizeof($this->getVar("available_sets")) > 0) {
	...
	<div>
<?php
            print caFormTag($this->request, 'Index', 'caSearchSetsForm', 'find/SearchEntities', 'post', 'multipart/form-data', '_top', array('noCSRFToken' => true, 'disableUnsavedChangesWarning' => true));
