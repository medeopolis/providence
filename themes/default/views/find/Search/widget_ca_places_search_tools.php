<?php
/* ----------------------------------------------------------------------
 * themes/default/views/find/Search/widget_ca_places_search_tools.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
<h3><?php print _t("History"); ?>:
	<div>
<?php
            print caFormTag($this->request, 'Index', 'caSearchHistoryForm', 'find/SearchPlaces', 'post', 'multipart/form-data', '_top', array('noCSRFToken' => true, 'disableUnsavedChangesWarning' => true));
...
if (sizeof($this->getVar("available_sets")) > 0) {
	...
	<div>
<?php
            print caFormTag($this->request, 'Index', 'caSearchSetsForm', 'find/SearchPlaces', 'post', 'multipart/form-data', '_top', array('noCSRFToken' => true, 'disableUnsavedChangesWarning' => true));
