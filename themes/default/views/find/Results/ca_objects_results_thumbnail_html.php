...
if (!($vs_caption_template = $this->request->config->get('ca_objects_results_thumbnail_caption_template'))) {
    $vs_caption_template = "^ca_objects.preferred_labels.name%truncate=27&ellipsis=1<br/>^ca_objects.idno";
}
