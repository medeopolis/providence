...
if (!($vs_caption_template = $this->request->config->get('ca_occurrences_results_thumbnail_caption_template'))) {
    $vs_caption_template = "^ca_occurrences.preferred_labels.name%truncate=27&ellipsis=1<br/>^ca_occurrences.idno";
}
