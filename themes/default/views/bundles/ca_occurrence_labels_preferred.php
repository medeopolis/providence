...
$read_only				= ((isset($settings['readonly']) && $settings['readonly'])  || ($this->request->user->getBundleAccessLevel('ca_occurrences', 'preferred_labels') == __CA_BUNDLE_ACCESS_READONLY__));
...
?>
	<textarea class='caLabelTemplate' style='display: none;'>
		<div id="{fieldNamePrefix}Label_{n}" class="labelInfo">
			...
			<div class="formLabel">
				<?php if (Configuration::load()->get('ca_occurrences_user_settable_sortable_value')) {
...
?>
	...
	<div class="bundleContainer">
		...
		<div class='button labelInfo caAddLabelButton' style="margin-left: 10px;"><a href='#'><?= caNavIcon(__CA_NAV_ICON_ADD__, '15px'); ?> <?= $add_label ? $add_label : _t("Add label"); ?></a></div>
	</div>
