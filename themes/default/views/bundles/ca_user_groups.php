				...
				<tr>
					<td class="formLabel">
						...
						<?php if ($t_rel->hasField('effective_date')) {
						    print _t(' for period ').$t_rel->htmlFormElement('effective_date', '^ELEMENT', ['name' => $vs_id_prefix.'_effective_date_{n}', 'value' => '{{effective_date}}',  'no_tooltips' => true, 'classname'=> 'dateBg']);
						} ?>
