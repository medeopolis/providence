...
$read_only				= ((isset($settings['readonly']) && $settings['readonly'])  || ($this->request->user->getBundleAccessLevel('ca_storage_locations', 'nonpreferred_labels') == __CA_BUNDLE_ACCESS_READONLY__));
