				...
				<tr valign="middle">
					<td>
						<table>
							...
							<tr>
								<td>
									<?= $t_label->htmlFormElement('description', null, array('name' => "{fieldNamePrefix}description_{n}", 'id' => "{fieldNamePrefix}description_{n}", "value" => "{{description}}", 'no_tooltips' => false, 'textAreaTagName' => 'textentry', 'readonly' => $read_only, 'tooltip_namespace' => 'bundle_ca_list_item_labels_preferred')); ?>
								</td>
							</tr>
							<tr>
								<td>
									<div class="formLabel">
										<?php if (Configuration::load()->get('ca_list_items_user_settable_sortable_value')) {
...
<script type="text/javascript">
	caUI.initLabelBundle('#<?= $id_prefix; ?>Labels', {
		...
		templateValues: ['name_singular', 'name_plural', 'description', 'locale_id', 'type_id', 'effective_date', 'access', 'name_sort'],
