<?php
/* ----------------------------------------------------------------------
 * bundles/ca_metadata_alert_rule_labels_preferred.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
$vb_read_only		=	((isset($va_settings['readonly']) && $va_settings['readonly'])  || ($this->request->user->getBundleAccessLevel('ca_metadata_alert_rules', 'preferred_labels') == __CA_BUNDLE_ACCESS_READONLY__));
