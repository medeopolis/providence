...
$read_only				= ((isset($settings['readonly']) && $settings['readonly'])  || ($this->request->user->getBundleAccessLevel('ca_places', 'preferred_labels') == __CA_BUNDLE_ACCESS_READONLY__));
...
?>
	<textarea class='caLabelTemplate' style='display: none;'>
		<div id="{fieldNamePrefix}Label_{n}" class="labelInfo">
			...
			<div class="formLabel">
				<?php if (Configuration::load()->get('ca_places_user_settable_sortable_value')) {
