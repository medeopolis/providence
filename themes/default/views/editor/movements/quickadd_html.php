...
<script type="text/javascript">
	var caQuickAddFormHandler = caUI.initQuickAddFormHandler({
		...
		formUrl: '<?= caNavUrl($this->request, 'editor/movements', 'MovementQuickAdd', 'Form'); ?>',
		fileUploadUrl: '<?= caNavUrl($this->request, "editor/movements", "MovementEditor", "UploadFiles"); ?>',
		saveUrl: '<?= caNavUrl($this->request, "editor/movements", "MovementQuickAdd", "Save"); ?>',
