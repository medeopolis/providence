...
<script type="text/javascript">
	var caQuickAddFormHandler = caUI.initQuickAddFormHandler({
		...
		formUrl: '<?= caNavUrl($this->request, 'editor/entities', 'EntityQuickAdd', 'Form'); ?>',
		fileUploadUrl: '<?= caNavUrl($this->request, "editor/entities", "EntityEditor", "UploadFiles"); ?>',
		saveUrl: '<?= caNavUrl($this->request, "editor/entities", "EntityQuickAdd", "Save"); ?>',
