...
<script type="text/javascript">
	var caQuickAddFormHandler = caUI.initQuickAddFormHandler({
		...
		formUrl: '<?= caNavUrl($this->request, 'editor/storage_locations', 'StorageLocationQuickAdd', 'Form'); ?>',
		fileUploadUrl: '<?= caNavUrl($this->request, "editor/storage_locations", "StorageLocationEditor", "UploadFiles"); ?>',
		saveUrl: '<?= caNavUrl($this->request, "editor/storage_locations", "StorageLocationQuickAdd", "Save"); ?>',
