<?php
/* ----------------------------------------------------------------------
 * app/views/editor/object_lots/quickadd_html.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
$vs_form_name = "ObjectLotQuickAddForm";
?>				
<script type="text/javascript">
	var caQuickAddFormHandler = caUI.initQuickAddFormHandler({
		...
		formUrl: '<?= caNavUrl($this->request, 'editor/object_lots', 'ObjectLotQuickAdd', 'Form'); ?>',
		fileUploadUrl: '<?= caNavUrl($this->request, "editor/object_lots", "ObjectLotEditor", "UploadFiles"); ?>',
		saveUrl: '<?= caNavUrl($this->request, "editor/object_lots", "ObjectLotQuickAdd", "Save"); ?>',
